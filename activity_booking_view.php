				...
				<form name="myform" class="pager-form" method="post" action="">
					<table id="sort-table"> 
						...
						<tbody>
							...
							<input type="hidden"  name="activity_activity_id" id="activity_activity_id" value=<?php echo $row['activity_activity_id']; ?>/>
							<tr>
								<td class="center"><input type="checkbox" value="1" name="list" class="checkbox"/></td>
								<td><?php echo $row['activity_name']; ?></td>
								<td><?php echo $row['location_code']; ?></td>
								<td><?php echo $row['capacity'] - $row['attending'] .'/'.$row['capacity']; ?></td>
							...
							<td>
								 <a class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="See Class" href="<?php echo site_url().'customer_contact/customers_by_event/' . $row['event_event_id'] .'/' . $row['location_id'] ?>"> <span class="ui-icon ui-icon-person"></span> </a>
								 
								 <a class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="Change Event" href="<?php echo site_url().'event/event_view/' . $row['event_event_id'] . '/' . $row['activity_activity_id'].'/1' ?>"> <span class="ui-icon ui-icon-calendar"></span> </a>
								 
								 <a class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="Assign Instructor" href="<?php echo site_url().'event/assign_employees/' . $row['event_event_id'] . '/' . $row['activity_activity_id'] ?>"> <span class="ui-icon ui-icon-script"></span> </a>
