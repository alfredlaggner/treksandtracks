	...
	<?= validation_errors(); ?>
						<div id="inputform">
								...
								<table width="800" border="0">
										...
										<tr>
												<td>Attachment</td>
												<td><input type="text"  name="attachment_name" id="attachment_name"  class="text" value='<?php echo $row->attachment_name ?>'  /></td>
										</tr>
										<tr>
												<td>File Name</td>
												<td><input type="text"  name="file_name" id="file_name"  class="text" value='<?php echo $row->file_name ?>'  /></td>
										</tr>
										<tr>
