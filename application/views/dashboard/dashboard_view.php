						...
						<div id="inputform">
							<div>
								<ul>
									...
									<br />
									<li>
										<input type="submit" name="activity_update" value="Calendar View" class="buttons" />
...
?>
				<div id="inputform"  >
					...
					<?= form_open('dashboard/exp_excel#statistics',$attributes );?>
					<ul>
						<li>
							<label>Event</label>
							<select type="text" name="activity_id" id="activity_id" class="text"  value='<?=$activity_id?>' />
						...
						<li>
							...
							<input type="text" name="event_date_from" id="event_date_from" class="date_sel text" value="<?= $event_date_from?>"/>
							<input type="text" name="event_date_to" id="event_date_to" class="date_sel text" value="<?= $event_date_to?> "/>
						</li>
							<label>Booked from to</label>
							<input type="text" name="booking_date_from" id="booking_date_from"  class="date_sel text" value="<?= $booking_date_from ?>"  />
							<input type="text" name="booking_date_to" id="booking_date_to" class="date_sel text" value="<?= $booking_date_to ?>" />
						</li>
						<li>
							<input type="submit" class="buttons" name="today" value="Go" onclick="xajax_ledger_statistics (xajax.getFormValues( 'ledger_stats' )); return false;"  />
						...
						<!--<div id="ledger_result">-->
							...
							<form name="myform" class="pager-form" method="post" action="">
									...
									if ($row->discount > 0.00)
									{
									 ...
									 ?></td>
											<td><a class="btn_no_text btn ui-state-default ui-corner-all tooltip " title="View History" href="<?php echo site_url().'customer_contact/customer_contact_overview/' ?><?php echo $row->customer_id; ?>//<?php echo str_replace( '@','at', $email); ?>/<?= strpos ($email,'@')==0 ? 0 : strpos ($email,'@')  ?>"> <span class="ui-icon ui-icon-folder-collapsed"></span> </a> <a class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="See Class" href="<?php echo site_url().'customer_contact/customers_by_event/' . $row->event_id .'/' . $row->location_id ?>"> <span class="ui-icon ui-icon-person"></span> </a> <a class="btn_no_text btn ui-state-default ui-corner-all tooltip " title="Edit customer" href="<?php echo site_url().'customer/customer_view/' ?><?php echo $row->customer_id; ?>"> <span class="ui-icon ui-icon-wrench"></span> </a></td>
										</tr>
				...
				<div id="inputform"  > <?php echo validation_errors(); ?>
					...
					<ul>
						<li>
							...
							<input type="text" name="discount_code" id="discount_code"  class="text" value="<?= $discount_code ?>"  />
						</li>
						<li>
