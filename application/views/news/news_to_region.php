		...
		<div class="hastable">
			...
			<div class="hastable">
				...
				<table id="sort-table">
					...
					<tbody>
						<tr>
							<input type="hidden" value="<?php echo $region->region_id; ?>" name="region_id<?php echo  $i  ?>" id="region_id<?php echo  $i  ?>" />
...
?>
				...
				<input type="submit" name="assign_region" value="Assign Regions" class="ui-state-default float-right ui-corner-all ui-button" />
						</tr>
				</table>
				</form>
				<i class="note"></i> </div>
