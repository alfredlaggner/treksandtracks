...
<div id="sub-nav">
	<div class="page-title">
		<h1><?= $title ?></h1>
		<span><a href="#" title="Home">Home</a> > <a href="#" title="Dashboard">Dashboard</a> > <?= anchor('news', 'news Overview'); ?> > <?= $title_action ?></span> </div>
...
-->								<li>
							...
							<li>
								<label>Group</label>
								<select type="text" name="news_group_id" id="news_group_id" class="text"  value='<?= $row->news_group_id; ?>'  />
								
								<? if(isset($news_groups)) : foreach($news_groups as $news_group) : ?>
								<? if ($row->news_group_id == $news_group->news_group_id) : ?>
								<option selected value="<?=  $news_group->news_group_id; ?>"><?=  $news_group->name; ?></option>
								<? else : ?>
								<option          value="<?=  $news_group->news_group_id; ?>"><?=  $news_group->name; ?></option>
								<? endif; ?>
								<? endforeach; ?>
								<? endif; ?>
								</select>
