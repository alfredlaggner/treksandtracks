										...
										<table id="sort-table">
												...
												<tbody>
														...
														<tr>
																...
																<td><a class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="Edit news" href="<?= site_url().'news/news_view/' ?><?= $row->news_id; ?>"> <span class="ui-icon ui-icon-wrench"></span> </a> 
																<a class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="Edit Pictures" href="<?= site_url().'news_pictures/index/0/' ?><?= $row->news_id . '/' .$row->code  ?>"> <span class="ui-icon ui-icon-image"></span> </a> 

																<a class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="Related newss" href="<?= site_url().'news_related/index/' ?><?= $row->news_id  ?>"> <span class="ui-icon ui-icon-link"></span> </a> 
																
																
																<a class="btn_no_text btn ui-state-default ui-corner-all tooltip confirmClick" title="Delete news" href="<?= site_url().'news/delete/' ?><?= $row->news_id; ?>"> <span class="ui-icon ui-icon-trash"></span> </a></td>
														</tr>
														<? endforeach; endif; ?>
												</tbody>
										</table>
