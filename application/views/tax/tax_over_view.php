				...
				<table id="sort-table">
					...
					<tbody>
						...
						<tr>
							...
							<td><a class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="Edit Tax" href="<?php echo site_url().'tax/tax_edit/' ?><?php echo $row->tax_id; ?>"> <span class="ui-icon ui-icon-wrench"></span> </a> 
							
<a class="btn_no_text btn ui-state-default ui-corner-all tooltip confirmClick" title="Delete Tax" href="<?php echo site_url().'tax/tax_delete/' ?><?php echo $row->tax_id ?>"> <span class="ui-icon ui-icon-trash"></span> </a>
