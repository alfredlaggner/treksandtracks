	...
	<div id="page-content-wrapper">
		...
		<div class="content-box">
			<div id="inputform">
				...
				<ul>
					<input type="hidden" name="tax_plan_id" id="tax_plan_id" class="text"  value='<?php echo $row->tax_plan_id; ?>'/>
					<li>
					<label> Name</label>
					<input type="text" name="name" id="name" minlength="3"  class="text"  value='<?php echo $row->name; ?>'/>
					</li>
					<li>
			...
			<?php if(isset($taxs)) : foreach($taxs as $tax) : ?>
						<tr>
							...
							<td> <a class="btn_no_text btn ui-state-default ui-corner-all tooltip confirmClick" title="Remove Tax" href="<?php echo site_url().'tax/delete_tax_plan_to_tax/'. $row->tax_plan_id . '/' .$tax->tax_id ?>"> <span class="ui-icon ui-icon-trash"></span> </a></td>
						</tr>
				<?php endforeach; ?>
				<?php else: ?>
				...
				<?php endif; ?>
					...
					<input type="submit" name="add_taxes" value="Add Taxes" class="ui-state-default float-right ui-corner-all ui-button" />
