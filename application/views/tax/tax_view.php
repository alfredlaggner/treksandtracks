...
<div id="sub-nav">
	<div class="page-title">
		...
		<span><a href="#" title="Home">Home</a> > <a href="#" title="Dashboard">Dashboard</a> > <?php echo anchor('tax', 'Tax Overview'); ?> > <?php echo $title_action ?></span> </div>
		...
		<div id="page-content-wrapper">
			...
			<div class="content-box">
				<div id="inputform">
					...
					<ul>
						<input type="hidden" name="tax_id" id="tax_id" class=" text"  value='<?php echo $row->tax_id; ?>'/>
						<li>
							<label>Name</label>
							<input type="text" name="name" id="name" class="required field text small" minlength="2"  value='<?php echo $row->name; ?>'/>
						</li>
						<li>
							<label>Order</label>
							<input type="text"  name="order" id="order" class="field text small" minlength="1"  value='<?php echo $row->order; ?>'/>
						</li>
						<li>
							<label class="desc"> Authority</label>
							<input type="text" name="authority" id="authority" class="required text"  value='<?php echo $row->authority; ?>'/>
						</li>
						<li>
						...
						<li>
							...
							<input type="text" name="amount" id="amount" class="number text" value='<?php echo $row->amount; ?>' />
						</li>
						<li>
