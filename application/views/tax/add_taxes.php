...
-->				<table>
					<thead>
						<tr>
							<th><input id="tax_add_submit" name="tax_add_submit" type="checkbox" value="check_none" onclick="this.value=check(this.form.list)" class="submit"/></th>
							<th>Name</th>
							<th>Authority</th>
							<th>Type</th>
							<th>Amount</th>
					...
					<tbody>
						...
						<?php $i++; ?>
						<tr>
							<td class="center"><input type="checkbox" id="tax_add<?php echo $i ?>" name="tax_add<?php echo  $i  ?>" value="1"  class="checkbox"/></td>
							
<input type="hidden" id="tax_id<?php echo  $i  ?>" name="tax_id<?php echo  $i  ?>" value="<?php echo $row->tax_id; ?>" />	
