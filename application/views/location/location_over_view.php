				...
				<form name="myform" class="pager-form" method="post" action="">
					<table id="sort-table">
						...
						<tr>
                            ...
                            <a class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="Edit Location" href="<?php echo site_url().'location/location_view/'?><?= $row->location_id?>"> <span class="ui-icon ui-icon-wrench"></span> </a>
                            
<!--                            
                            <a class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="Edit Coordinates" href="<?php echo site_url().'coordinates/index/'?><?= $row->location_id?>"> <span class="ui-icon ui-icon-extlink"></span> </a>
                            
-->                            
                             <a class="btn_no_text btn ui-state-default ui-corner-all tooltip confirmClick" title="Delete Location" href="<?php echo site_url().'location/delete/'?><?= $row->location_id?>"> <span class="ui-icon ui-icon-trash"></span> </a></td>
						</tr>
				<? endforeach; endif; ?>
							</tbody>
