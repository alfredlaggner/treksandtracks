			...
			<div id="inputform">
				<table width="800" border="0">
					...
					<tr>
						...
						<td><textarea class="text_area" name="description_long" id="description_long"rows="3" cols="30"></textarea></td>
					</tr>
					<tr>
						<td>Directions</td>
						<td><textarea class="text_area" name="directions" id="directions"rows="3" cols="30"></textarea></td>
					</tr>
					<tr>
						<td>Map Link</td>
