					...
					<table id="sort-table">
						...
						<tbody>
							...
							<tr>
								...
								<td><a class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="Edit Event" href="<?php echo site_url().'activity_date/activity_date_view/' ?><?php echo $row2->activity_date_id; ?>/<?php echo $row->activity_id; ?>"> <span class="ui-icon ui-icon-calendar"></span> </a> <a class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="Assign Instructors" href="<?php echo site_url().'activity_date/assign_employees/' ?><?php echo $row2->activity_date_id . '/'. $row->activity_id; ?>"> <span class="ui-icon ui-icon-plus"></span> </a> <a class="btn_no_text btn ui-state-default ui-corner-all tooltip confirmClick" title="Delete Event" href="<?php echo site_url().'activity/delete/' ?><?php echo $row->activity_id; ?>"> <span class="ui-icon ui-icon-trash"></span> </a></td>
							</tr>
							<?php endforeach; endif; ?>
						</tbody>
					</table>
