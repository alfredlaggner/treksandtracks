...
<div id="sub-nav">
	<div class="page-title">
		<h1><?= $title ?></h1>
		<span><a href="#" title="Home">Home</a> > <a href="#" title="Dashboard">Dashboard</a> > <?= anchor('activity/event_view/'.$activity_id, 'Activity Date Overview'); ?> > <?= $title_action ?></span> </div>
				...
				<div id="inputform">
					...
					<ul>
						...
						<li>
							...
							<select type="text" name="location_id" id="location_id" class="text"  value='<?= $row->location_id; ?>' />
						...
						<li>
							...
							<input type="text" name="capacity_max" id="capacity_max"  class="required text"  value="<?=  $row->capacity_max; ?>" />
						</li>
						<li>
