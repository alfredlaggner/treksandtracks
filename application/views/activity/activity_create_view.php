...
-->								<li>
								...
								<li>
									...
									<input type="text" name="description_short" id="description_short"  class="text" value='' />
								</li>
								<li>
								...
								<li>
									...
									<textarea class="text_area" name="description_detailled" id="description_detailled"></textarea>
								</li>
								<li>
					...
					<div id="inputform">
						<ul>
							...
							<li>
								...
								<select type="text" name="physical_level_id" id="physical_level_id" class="text"   value=''/>
							...
							<li>
								...
								<select type="text" name="service_level_id" id="service_level_id" class="text" value='' />
				...
				<div id="tabs-3">
					<div id="inputform">
						<ul>
							<li> Inquiry Message
								<select type="text" name="inquiry_message_id" id="inquiry_message_id" class="text"  value=''/>
							...
							<li> Confirmation Message
								<select type="text" name="confirmation_message_id" id="confirmation_message_id" class="text"  value='' />
							...
							<li> Booking Message
								<select type="text" name="booking_message_id" id="booking_message_id" class="text"  value='' />
