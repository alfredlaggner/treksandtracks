...
<div id="sub-nav">
	<div class="page-title">
		<h1><?= $title ?></h1>
		<span><a href="#" title="Home">Home</a> > <a href="#" title="Dashboard">Dashboard</a> > <?= anchor('activity', 'Activity Overview'); ?> > <?= $title_action ?></span> </div>
...
-->								<li>
									...
									<select type="text" name="division_id" id="division_id" class="text"  value='<?= $row->division_id; ?>' />
									
									<? if(isset($divisions)) : foreach($divisions as $division) : ?>
									<? if ($row->division_id == $division->division_id) : ?>
									<option selected value="<?=  $division->division_id; ?>"><?=  $division->name; ?></option>
									<? else : ?>
								...
								<li>
									<h3>Short Summary</h3>
									<input type="text" name="description_short" id="description_short"  class="text" value='<?= $row->description_short; ?>' />
								</li>
								<li>
									<h3>Activity Text</h3>
									<textarea class="text_area" name="description_long" id="description_long"> <?= $row->description_long; ?></textarea>
								</li>
								<li>
									<h3>They'll learn</h3>
									<textarea class="text_area" name="they_learn" id="they_learn"> <?= $row->they_learn; ?></textarea>
								</li>
								<li>
									<h3>What's great about it</h3>
									<textarea class="text_area" name="description_detailled" id="description_detailled"> <?= $row->description_detailled; ?></textarea>
								</li>
								<li>
									<h3>What to expect</h3>
									<textarea class="text_area" name="to_expect" id="to_expect"><?= $row->to_expect; ?></textarea>
								</li>
								<li>
									<h3>You bring</h3>
									<textarea class="text_area" name="they_bring" id="they_bring"><?= $row->they_bring; ?></textarea>
								</li>
								<li>
									<h3>We provide</h3>
									<textarea class="text_area" name="we_provide" id="we_provide"><?= $row->we_provide; ?></textarea>
								</li>
							</ul>
						</div>
						<div class="clear"></div>
				...
				<div id="tabs-2">
					<div id="inputform">
						<ul>
							<li>
								<label>Style</label>
								<select type="text" name="style_id" id="style_id" class="text"  value='<?= $row->style_id; ?>'  />
							...
							<li>
								...
								<select type="text" name="physical_level_id" id="physical_level_id" class="text"   value='<?= $row->physical_level_id; ?>'/>
								...
								<option selected value="<?=  $physical_level->physical_level_id; ?>"><?=  $physical_level->name; ?></option>
								<? else : ?>
								<option          value="<?=  $physical_level->physical_level_id; ?>"><?=  $physical_level->name; ?></option>
								<? endif; ?>
								<? endforeach; ?>
								<? endif; ?>
								</select>
							...
							<li>
								...
								<select type="text" name="service_level_id" id="service_level_id" class="text" value='<?= $row->service_level_id; ?>' />
								
								<? if(isset($service_levels)) : foreach($service_levels as $service_level) : ?>
								<? if ($row->service_level_id == $service_level->service_level_id) : ?>
								<option selected value="<?=  $service_level->service_level_id; ?>"><?=  $service_level->name; ?></option>
								<? else : ?>
								<option          value="<?=  $service_level->service_level_id; ?>"><?=  $service_level->name; ?></option>
								<? endif; ?>
								<? endforeach; ?>
								<? endif; ?>
								</select>
							...
							<li>
								...
								<input type="text" name="duration" id="duration" class="digits text"  value='<?= $row->duration; ?>'/>
							</li>
							<li>
								<label>Duration Text</label>
								<input type="text" name="duration_text" id="duration_text" class="text"  value='<?= $row->duration_text; ?>'/>
							</li>
							<li>
								<label>Minimum capacity</label>
								<input type="text" name="capacity_min" id="capacity_min" class="digits text"  value='<?= $row->capacity_min; ?>'/>
							</li>
							<li>
								<label>Maximum capacity</label>
								<input type="text" name="capacity_max" id="capacity_max" class="digits text"  value='<?= $row->capacity_max; ?>' />
							</li>
							<li>
								<label>Minimum Age</label>
								<input type="text" name="age_min" id="age_min" class="digits text"  value='<?= $row->age_min; ?>'/>
							</li>
							<li>
								<label>Maximum Age</label>
								<input type="text" name="age_max" id="age_max" class="digits text" value='<?= $row->age_max; ?>' />
							</li>
							<li>
							...
							<li>
								...
								<?= form_checkbox('is_questionaire', $row->is_questionaire, $row->is_questionaire) ?> </li>
						</ul>
					</div>
				</div>
				<div id="tabs-3">
...
-->							<li>
								...
								<select type="text" name="inquiry_message_id" id="inquiry_message_id" class="text"  value='<?= $row->inquiry_message_id; ?>'/>
								...
								<option selected value="<?=  $inquiry_message->inquiry_message_id; ?>"><?=  $inquiry_message->name; ?></option>
								<? else : ?>
								<option          value="<?=  $inquiry_message->inquiry_message_id; ?>"><?=  $inquiry_message->name; ?></option>
								<? endif; ?>
								<? endforeach; ?>
								<? endif; ?>
								</select>
							...
							<li>
								...
								<select type="text" name="confirmation_message_id" id="confirmation_message_id" class="text"  value='<?= $row->confirmation_message_id; ?>' />
								...
								<option selected value="<?=  $confirmation_message->confirmation_message_id; ?>"><?=  $confirmation_message->name; ?></option>
								<? else : ?>
								<option          value="<?=  $confirmation_message->confirmation_message_id; ?>"><?=  $confirmation_message->name; ?></option>
								<? endif; ?>
								<? endforeach; ?>
								<? endif; ?>
								</select>
							...
							<li>
								...
								<select type="text" name="booking_message_id" id="booking_message_id" class="text"  value='<?= $row->booking_message_id; ?>' />
								...
								<option selected value="<?=  $booking_message->booking_message_id; ?>"><?=  $booking_message->name; ?></option>
								<? else : ?>
								<option          value="<?=  $booking_message->booking_message_id; ?>"><?=  $booking_message->name; ?></option>
								<? endif; ?>
								<? endforeach; ?>
								<? endif; ?>
								</select>
