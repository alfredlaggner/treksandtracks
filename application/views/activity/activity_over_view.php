...
-->																<th>Code</th>
												...
												<tbody>
														<? $region='0';if(isset($regions)) : foreach($regions as $region) : ?>
...
-->																<td><?= $row->code; ?></td>
																...
																<td><a class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="Edit Activity" href="<?= site_url().'activity/activity_view/' ?><?= $row->activity_id; ?>"> <span class="ui-icon ui-icon-wrench"></span> </a> 
																<a class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="Edit Event Dates" href="<?= site_url().'event/index/' ?><?= $row->activity_id; ?>"> <span class="ui-icon ui-icon-calendar"></span> </a> 
																<a class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="Edit Event Rates" href="<?= site_url().'activity_rate/index/' ?><?= $row->activity_id; ?>"> <span class="ui-icon ui-icon-arrowreturnthick-1-n"></span> </a> 
																<a class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="Edit Pictures" href="<?= site_url().'activity_pictures/index/0/' ?><?= $row->activity_id . '/' .$row->code  ?>"> <span class="ui-icon ui-icon-image"></span> </a> 

																<a class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="Related Activities" href="<?= site_url().'activity_related/index/' ?><?= $row->activity_id  ?>"> <span class="ui-icon ui-icon-link"></span> </a> 
																<a class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="Assign Regions" href="<?= site_url().'activity/assign_regions/' ?><?= $row->activity_id  ?>"> <span class="ui-icon ui-icon-link"></span> </a> 
