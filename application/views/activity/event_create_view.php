...
<div id="sub-nav">
	<div class="page-title">
		...
		<span><a href="#" title="Home">Home</a> > <a href="#" title="Dashboard">Dashboard</a> > <?php echo anchor('activity/event_view/'.$activity_id, 'Activity Date Overview'); ?> > <?php echo $title_action ?></span> </div>
