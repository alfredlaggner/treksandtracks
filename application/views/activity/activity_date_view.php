...
<div id="sub-nav">
		<div class="page-title">
				...
				<span><a href="#" title="Home">Home</a> > <a href="#" title="Dashboard">Dashboard</a> > <?php echo anchor('activity/activity_date_view/'.$activity_id, 'Activity Date Overview'); ?> > <?php echo $title_action ?></span> </div>
										...
										<ul>
												<input type="hidden" name="activity_id" id="activity_id"  value='<?php echo $activity_id ?>' />
	  										   ...
	  										   <input type="hidden" name="from_calendar" id="from_calendar"  value='<?php echo $from_calendar ?>' />
														...
														<input type="hidden" name="available" id="available"   value="<?php echo  $row->available; ?>" />
												<input type="hidden" name="activity_date_id" id="activity_date_id"  value='<?php echo $row->activity_date_id ?>' />
												<li>
														<label>Date </label>
														<input type="text" name="date" id="date"  class="text" value="<?php echo  $row->date; ?>" />
												</li>
												<li>
														<label>Time </label>
														<input type="text" name="time" id="time"  class="text"  value="<?php echo  $row->time; ?>"/>
														
											</li>
												<li>
														<label>Capacity</label>
														<input type="text" name="capacity_max" id="capacity_max"  class="required text"  value="<?php echo  $row->capacity_max; ?>" />
												</li>
												<li>
