			...
			<ul>
				...
				<div class="hastable">
					...
					<table id="sort-table">
						...
						<tbody>
							<?php $i=0; if(isset($dates)) : foreach($dates as $row2) : ?>
														<? 
							$status = "";
							if ($row2->is_deleted)
									$status = "Invisible";
							...
							<tr>
								...
								<td>
								<a class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="Edit Event" href="<?php echo site_url().'event/event_view/' ?><?php echo $row2->event_id; ?>/<?php echo $row->activity_id; ?>"> <span class="ui-icon ui-icon-calendar"></span> </a> 
								<a class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="Assign Instructors" href="<?php echo site_url().'event/assign_employees/' ?><?php echo $row2->event_id . '/'. $row->activity_id; ?>"> <span class="ui-icon ui-icon-plus"></span> 
								</a> 
