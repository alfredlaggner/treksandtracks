...
-->
			...
			<li>
					...
					<input id="creditcard" type="text" class="validate[required,creditCard] text " size="16" name="x_card_num" value="6011000000000012"><!--6011000000000012-->
					</input>
				</li>
				<li>
					<label>Exp.(yy/mm)</label>
					<input id="exp" type="text" class="text validate[required]" size="4" name="x_exp_date" value="0513">
					</input>
				</li>
				<li>
					<label>CCV</label>
					<input id="ccv" type="text" class="text validate[required]" size="4" name="x_card_code" value="782"><!--782-->
					</input>
			</fieldset>
