...
<? $picture = base_url() . GEARS_IMAGE_DIR . strtoupper($related->code) . '/' . $related->picture ; ?>
	<div class="sg-8 collection-product focus-box"> <a href="<?= site_url() . "tt_v2/gear/" . $related->gear_id ?>"><img src="<?= $picture  ?>" class="preload" alt="<?= $related->name ?>" /></a>
		<div class="line"></div>
		<div class="collection-product-description"><? $related->slogan ?><a href="<?= site_url() . "tt_v2/gear/" . $related->gear_id ?>"><?= $related->name ?></a>
