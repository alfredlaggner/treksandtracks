...
<!-- !top-bar -->
<div id="top-bar">
		<div id="top-bar-content"> <span id="top-bar-content-user"> logged in as <a href="javascript:void(0)">Adam</a> (<a href="javascript:void(0)">logout</a>) </span> <a href="../../../akaishi/html/cart.html" id="top-bar-checkout">checkout</a> <span id="top-bar-content-items">you have 4 products in your cart</span> </div>
</div>
...
<!--				 <? if ($records) : foreach ($records as $row) : ?>
            ...
            <div class="sg-8 collection-product focus-box">
                <a class="collection-product-thumb" href="<?= site_url() . "tt_v2/product/" . $row->activity_id ?>"><img  src="<?= $picture ?> "  alt="product title" /></a>
                <div class="line"></div>
                <div class="collection-product-description">
                    <a href="<?= site_url() . "tt_v2/product/" . $row->activity_id ?>"><?= $row->name ?></a>
