...
-->            </span>
            <a href="#openModal"   id="top-bar-checkout" > <?= $region_name ?></a>
            <span id="top-bar-content-items">select Region </span>
       </div>
    </div>
...
<div id="openModal" class="modalDialog">
	<div>
        ...
        <p>&nbsp;</p>
								...
								<?= form_open('tt_v2/region_update/'.$region_id,$attributes );?>
						...
						<input type="submit" name="return" value="Go!" class="buttons" />
					<?= form_close(); ?>
	</div>	
</div>
        ...
        <div id="container">
            ...
            <section id="home-slider" class="sg-23">
                ...
                <div id="home-slider-photo">
					...
					<? else : ?>					
						<img id="home-slider-photo-<?= $i ?>" class="home-slider-photo preload home-slider-photo-unsel" src="<?= $picture ?>" alt="" />
					<? endif ?>					
				    <? $i++ ?>
					<? endforeach; endif ?>
...
-->					<? endif ?>					
                ...
                <div id="home-slider-description">
					...
					<? else : ?>					
						<div id="home-slider-description-<?= $i ?>" class="home-slider-description  home-slider-description-unsel">
							<h2><?= $row->name ?></h2>
							<p><?= $row->description_short ?></p>
						</div>
					<? endif ?>
            ...
            <div class="scroll-pane">
                <div id="home-intro-content">
                    ...
                    <p>"Our Treks and Tracks guides were fabulous! They were incredibly knowledgeable and skilled, super nice and friendly, and very helpful in instructing me about rock climbing. I had a great experience and would definitely go back. Also, they provided all of the gear, including shoes, which was great."<br>October 26, 2011
</p>
                </div></div>
                
                <a  id="home-intro-cta" onClick="MM_openBrWindow('<?= site_url() . "menu_pages/" ?>testimonials','testimonials','toolbar=yes,menubar=yes,resizable=yes,width=600,height=600')">Read more<span></span></a>
            </div>
...
<? if ($records and  $featured) : foreach ($records as $row) : ?>
            ...
            app.isotope.vars.homeFeaturedProducts[productId] = {
                ...
                url   : '<?= site_url() . "tt_v2/product/" . $row->activity_id ?>'
            };
<? endforeach; endif ?>
            </script>
...
<? if ($records and  $featured) : foreach ($records as $row) : ?>
 			<? $picture = base_url() . CLASSES_IMAGE_DIR . strtoupper($row->code) . '/' . $row->picture ?>
                    <div class="home-featured-item" id="home-featured-item-id:<?= $row->activity_id ?>"><img class="home-featured-item-thumb preload" src="<?= $picture ?>" alt="" /></div>
<? endforeach; endif ?>
                </div>
			...
			<div id="product_display">
				...
				<div id="capslide_img_cont<?= $i ?>" class="sg-8 collection-product  ic_container "> <a  class="collection-product-thumb" href="<?= site_url() . "tt_v2/product/" . $row->activity_id ?>"><img  src="<?= $picture ?> " height="223" width="223" alt="product title" />
						<div class="overlay" style="display:none;"></div>
						</a>
						<div class="line"></div>
						<div class="collection-product-description"> <a href="<?= site_url() . "tt_v2/product/" . $row->activity_id ?>">
								<?= $row->name ?>
								</a>
...
<!--             <div class="sg-35">
			...
			<div id="gear_display">
				...
				<div id="capslide_img_cont<?= $i ?>" class="sg-8 collection-product  ic_container "> <a  class="collection-product-thumb" href="<?= site_url() . "tt_v2/gear/" . $gear->gear_id ?>"><img  src="<?= $picture ?> " height="223" width="223" alt="product title" />
						<div class="overlay" style="display:none;"></div>
						</a>
						<div class="line"></div>
						<div class="collection-product-description"> <a href="<?= site_url() . "tt_v2/gear/" . $gear->gear_id ?>">
								<?= $gear->name ?>
								</a>
								<div class="collection-product-description-price"> <span>$</span>
										<?= '10.99' ?>
...
-->
 ...
 <!-- End Gear -->           
            ...
            <!-- !line -->
 			<? $this->load->view('tt_v2/blocks/footer_boxes'); ?>
            <!-- !PAGE-CONTENT-END -->
