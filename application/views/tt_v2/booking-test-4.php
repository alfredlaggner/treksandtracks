...
<!--test area-->
        ...
        <? $is_month = '-1'; ?>
                               ...
                               <div class="panel style1">
                                    <h4 class="panel-title">
                                        <a class="collapsed" href="#acc<?= $j ?><?= $i ?>" data-toggle="collapse" data-parent="#accordion1"><?= $location->name ?></a>
                                    </h4>
    ...
    <!--events content-->  
				...
				?>
																...
																<h5><a  title="Click to select date and time" style="font-size:12px; text-decoration:none" href="#" id="go_book<?= $disable ?><?= $j ?><?= $i ?>"  > 
