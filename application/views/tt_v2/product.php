...
<? endif ?>
		<div id="product-image" class="sg-17">
			...
			<form id="product-image-buy" method="post" action="<?= site_url() . 'tt_v2/product_booking1/' . $row->activity_id ?>">
				<a href="<?= site_url() . 'tt_v2/product_booking1/' . $row->activity_id ?>" id="product-image-buy-link">see dates and book</a>
			</form>
		</div>
		<div id="product-description" class="sg-17">
			...
			<div id="product-description-data">
				<div class="line"></div>
				<div class="product-description-data-row"><span class="product-description-data-row-label">level</span><span>
					<?= $row->service_level_name ?>
					</span></div>
				<div class="product-description-data-row"><span class="product-description-data-row-label">style</span><span>
					<?= $row->style_name ?>
					</span></div>
				<div class="line"></div>
				<div class="product-description-data-row"><span class="product-description-data-row-label">challenge</span><span>
					<?= $row->physical_level_name ?>
					</span></div>
				<div class="product-description-data-row"><span class="product-description-data-row-label">age</span><span>
					<?= $row->age_min ?>
					and up</span></div>
				<div class="line"></div>
				...
				<div id="product-description-data-thumbs">
					...
					<a rel="shadowbox[gallery]" href="<?= $picture ?>"><img width="100" class="preload" src="<?= $picture ?>" alt="" /></a>
					<? endif ?>
					<? $i++ ?>
					<? endforeach ?>
				</div>
...
-->		</div>
		...
		<div class="sg-12">
			...
			<div class="line"></div>
				<div class="product-description-data-row-goals"><span class="product-description-data-row-label">locations</span><span>
			<? foreach ($locations as $location) : ?>
...
<? $picture = base_url() . CLASSES_IMAGE_DIR . strtoupper($related->code) . '/' . $related->picture ; ?>
	<div class="sg-8 collection-product focus-box"> <a href="<?= site_url() . "tt_v2/product/" . $related->activity_id ?>"><img src="<?= $picture  ?>" class="preload" alt="<?= $related->name ?>" /></a>
		<div class="line"></div>
		<div class="collection-product-description"><? $related->slogan ?><a href="<?= site_url() . "tt_v2/product/" . $related->activity_id ?>"><?= $related->name ?></a>
