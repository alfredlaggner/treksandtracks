...
<div class="search-box-wrapper">
	<div class="search-box container">
		<ul class="search-tabs clearfix">
			...
			<li ><a onClick="xajax_getProducts(<?= $style->style_id ?>);return false;" href="#hotels-tab" data-toggle="tab">
				<?= $style->name ?>
				</a></li>
			<? endforeach; endif ?>
				...
				<div id="product_display" class="row image-box style1 add-clearfix">
					...
					<div class="col-sms-6 col-sm-6 col-md-3"  >
						<article class="box">
							...
							<div class="details">
								<h4 class="box-title"><a href="<?= site_url() . 'tt_v2/product/' . $row->activity_id ?>">
									<?= $row->name ?>
									<small>Paris</small></a></h4>
							...
							<a href="<?= site_url() . 'tt_v2/product_booking1/' . $row->activity_id ?>" class="button btn-small full-width">CHECK DATES</a> </article>
					</div>
					<? $i++ ?>
					<? endforeach ?>
					<? else : ?>
