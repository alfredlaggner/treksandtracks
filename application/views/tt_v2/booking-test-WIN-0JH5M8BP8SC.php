...
<!-- Current Page Styles -->
<link rel="stylesheet" type="text/css" href="<?= base_url() ?>travelo/components/revolution_slider/css/settings.css" media="screen" />
<link rel="stylesheet" type="text/css" href="<?= base_url() ?>travelo/components/revolution_slider/css/style.css" media="screen" />
<link rel="stylesheet" type="text/css" href="<?= base_url() ?>travelo/components/jquery.bxslider/jquery.bxslider.css" media="screen" />
...
<!--test area-->
	...
	<? if(isset($locations)) : foreach ($locations as $location) : ?>
                                    <h4 class="panel-title">
                                        <a class="collapsed" href="#acc2" data-toggle="collapse" data-parent="#accordion1"><?= $location->name ?></a>
                                    </h4>
		...
		<?  if(isset($events)) :foreach ($events as $event) : ?>
				...
				?>
																<p><a  title="Click to select date and time" style="font-size:12px; text-decoration:none" href="#" id="go_book<?= $disable ?><?= $j ?><?= $i ?>"  > 
...
<? if(isset($records)) : foreach ($records as $row) : ?>
	...
	<? if(isset($locations)) : foreach ($locations as $location) : ?>
		...
		<? $i = 1; ?>
		<? $k = 1; ?>
								<h4 class="panel-title"> <a class="collapsed" href="#acc<?= $j; ?>" data-toggle="collapse" data-parent="#location">
									<?= $location->name ?>
									</a> </h4>
		...
		<?  if(isset($events)) :foreach ($events as $event) : ?>
			<? if ($location->location_id == $event['location_id']) : ?>
				...
				<? if ($is_month != $pre_month ) : ?>
					...
					<? endif ?>
													<h4 class="panel-title"> <a href="#acc<?= $j; ?><?= $i; ?>" data-toggle="collapse" data-parent="#months">
...
<script type="text/javascript" src="<?= base_url() ?>travelo/components/revolution_slider/js/jquery.themepunch.plugins.min.js"></script> 
<script type="text/javascript" src="<?= base_url() ?>travelo/components/revolution_slider/js/jquery.themepunch.revolution.min.js"></script> 

<!-- load BXSlider scripts --> 
<script type="text/javascript" src="<?= base_url() ?>travelo/components/jquery.bxslider/jquery.bxslider.min.js"></script> 
