...
-->
	...
	<script type="text/javascript" src="<?= base_url() . 'akaishi/assets/js/' ?>jquery.columnizer.min.js" charset="utf-8"></script>    
...
-->	
    ...
    <link rel="stylesheet" type="text/css" href="<?= base_url() . 'akaishi/assets/css/' ?>jquery.jscrollpane.css" media="all" />
