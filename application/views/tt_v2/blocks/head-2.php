...
<head>
    ...
    <!-- Current Page Styles -->
    <link rel="stylesheet" type="text/css" href="<?= base_url() . COMPONENTS_DIR ?>components/revolution_slider/css/settings.css" media="screen" />
    <link rel="stylesheet" type="text/css" href="<?= base_url() . COMPONENTS_DIR ?>components/revolution_slider/css/style.css" media="screen" />
    <link rel="stylesheet" type="text/css" href="<?= base_url() . COMPONENTS_DIR ?>components/jquery.bxslider/jquery.bxslider.css" media="screen" />
    <link rel="stylesheet" type="text/css" href="<?= base_url() . COMPONENTS_DIR ?>components/flexslider/flexslider.css" media="screen" />
    ...
    <script type="text/javascript" src="<?= base_url() . JS_DIR ?>js/pace.min.js" data-pace-options="{ 'ajax': false }"></script>
