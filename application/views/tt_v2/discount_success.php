...
<? foreach ($records AS $row) : ?>
	...
	<h4> Date/Time: <b>
		...
		<?= date('g:i a',strtotime($row->time)+$row->duration * 3600); ?>
			...
			<p>Amount Paid: <? if ($row->ledger_price - $row->ledger_discount <= 0) echo '$0.00' ; else echo '$' . $row->ledger_price - $row->ledger_discount ; ?></p>
                <div class="line"></div>
...
<img height="1" width="1" style="border-style:none;" alt="" src="//www.googleadservices.com/pagead/conversion/985272587/?value=0&amp;label=_QgHCK3t2QUQi6Lo1QM&amp;guid=ON&amp;script=0"/>
</div>
</noscript>
</html>