...
<!-- Current Page Styles -->
<link rel="stylesheet" type="text/css" href="../../../travelo/components/revolution_slider/css/settings.css" media="screen" />
<link rel="stylesheet" type="text/css" href="../../../travelo/components/revolution_slider/css/style.css" media="screen" />
<link rel="stylesheet" type="text/css" href="../../../travelo/components/jquery.bxslider/jquery.bxslider.css" media="screen" />
						...
						<div class="person-information">
							...
							<div class="row">
								<div class="form-group col-sm-6 col-md-5">
									...
									<input type="text" class="input-text full-width validate[required]" name="first_name<?= $i ?>" id="first_name<?= $i ?>" value="" placeholder="First Name required"/>
									<? else : ?>
									<label>first name</label>
									<input type="text" class="input-text full-width" name="first_name<?= $i ?>" id="first_name<?= $i ?>" value=""  placeholder="First Name"/>
									<? endif ?>
								</div>
								<div class="form-group col-sm-6 col-md-5">
									<? if ($i==1) : ?>
									<label>last name<span> *</span></label>
									<input type="text" class="input-text full-width validate[required]" name="last_name<?= $i ?>" id="last_name<?= $i ?>" value="" placeholder="Last Name required" />
									<? else : ?>
									<label>last name</label>
									<input type="text" class="input-text full-width" name="last_name<?= $i ?>" id="last_name<?= $i ?>" value="" placeholder="Last Name" />
									<? endif ?>
								</div>
							</div>
							<div class="row">
								<div class="form-group col-sm-6 col-md-5">
									...
									<input type="text" class="input-text full-width validate[required,custom[email]]" name="email<?= $i ?>" id="email<?= $i ?>" value="" placeholder="Email required" />
									<? else : ?>
									<label>email address</label>
									<input type="text" class="input-text full-width" name="email<?= $i ?>" id="email<?= $i ?>" value="" placeholder="Email" />
									<? endif ?>
								</div>
								<div class="form-group col-sm-6 col-md-5">
									<? if ($i==1) : ?>
									<label>phone<span> *</span></label>
									<input type="text" class="input-text full-width validate[required]" name="cell<?= $i ?>" id="cell<?= $i ?>" value="" placeholder="cell required" />
									<? else : ?>
									y
									<label>phone</label>
									<input type="text" class="input-text full-width" name="cell<?= $i ?>" id="cell<?= $i ?>" value="" placeholder="cell" />
									<? endif ?>
								</div>
							</div>
							<div class="row">
								<div class="form-group col-sm-6 col-md-5">
									...
									<input type="text" class="input-text full-width" name="address1<?= $i ?>" id="address1<?= $i ?>" value="" placeholder="home address" />
								</div>
								<div class="col-xs-6">
									<label>State</label>
									<div class="selector">
										<select>
											<option value="uk">CA</option>
											<option value="uk">WA</option>
											<option value="uk">OR</option>
										</select>
									</div>
								</div>
								<div class="col-xs-6">
							...
							<div class="row">
								<div class="form-group col-sm-6 col-md-5">
									...
									<input type="text" class="input-text full-width validate[required]" name="emergency_contact<?= $i ?>" id="emergency_contact<?= $i ?>" value="" placeholder="emergency contact" />
								</div>
								<div class="form-group col-sm-6 col-md-5">
									<label>emergency phone</label>
									<input type="text" class="input-text full-width" name="emergency_phone<?= $i ?>" id="emergency_phone<?= $i ?>" value="" placeholder="emergency phone" />
								</div>
							</div>
							<div class="form-group">
								<div class="checkbox">
									<label>
										<input type="checkbox">
										I want to receive <span class="skin-color">Travelo</span> promotional offers in the future </label>
								</div>
							</div>
						</div>
						<hr />
<!--						<div class="card-information">
				...
				<div class="sidebar col-sm-4 col-md-3">
					<div class="booking-details travelo-box">
						...
						<article class="image-box cruise listing-style1">
							<figure class="clearfix"> <a title="" href="../../../travelo/cruise-detailed.html" class="hover-effect middle-block"><img class="middle-item" alt="" src="http://placehold.it/75x75"></a>
							...
							<div class="details">
								...
								<div class="constant-column-3 timing clearfix">
									<div class="check-in">
										...
										<span>FEB 10, 2014<br />
										10 am</span> </div>
									<div class="duration text-center"> <i class="soap-icon-clock"></i> <span>4 Nights</span> </div>
									<div class="check-out">
										<label>Returns</label>
										<span>feb 15, 2014<br />
										2 PM</span> </div>
								</div>
								<div class="guest"> <small class="uppercase">1 grand suite for <span class="skin-color">2 Persons</span></small> </div>
							</div>
						</article>
						<h4>Other Details</h4>
	...
	<footer id="footer">
				...
				<div class="row">
					...
					<div class="col-sm-6 col-md-3">
						...
						<ul class="travel-news">
							<li>
								<div class="thumb"> <a href="#"> <img src="http://placehold.it/63x63" alt="" width="63" height="63" /> </a> </div>
		...
		<div class="bottom gray-area">
			<div class="container">
				<div class="logo pull-left"> <a href="../../../travelo/index.html" title="Travelo - home"> <img src="../../../travelo/images/logo.png" alt="Travelo HTML5 Template" /> </a> </div>
...
<script type="text/javascript" src="../../../travelo/components/revolution_slider/js/jquery.themepunch.plugins.min.js"></script> 
<script type="text/javascript" src="../../../travelo/components/revolution_slider/js/jquery.themepunch.revolution.min.js"></script> 
