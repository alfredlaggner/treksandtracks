	...
	<body class="state1 background-100-e">
		<div class="ext-nav background-95-h page-transition">
			<div class="view half-height">
				<img alt class="bg static" src="<?php echo base_url()?>Theme/theme-viki/images/placeholders/1920x1200-1.jpg" />
				<div class="content no-top-padding no-bottom-padding  full-height">
					<div class="container-fluid  full-height">
						<div class="row full-height">
							<a href="<?php echo base_url()?>Theme/theme-viki/blog.html" class="col-md-6 colors-e background-95-e full-height">
								<div>
									<span class="side-label">All The Latest</span>
									<span class="side-title">Blog</span>
								</div>
							</a>
							<a href="<?php echo base_url()?>Theme/theme-viki/help.html" class="col-md-6 colors-f background-95-f full-height">
								<div>
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse">
					<ul class="nav navbar-nav navbar-right">
						...
						<li><a href="#work" class="hover-effect">Activities</a></li>
		...
		<section id="home">
			<div class="view">
				<img alt class="bg" src="<?php echo base_url()?>Theme/theme-viki/images/placeholders/1920x1200-0.jpg" /><img alt class="bg" src="<?php echo base_url()?>Theme/theme-viki/images/placeholders/1920x1200-1.jpg" />
						...
						<div class="row">
							<div class="col-md-5 col-md-offset-1">
								<div class="text-right textillate heading  hidden-xs hidden-sm" data-textillate-options="{loop:true, in:{effect:'flipInY', reverse:true}, out:{effect:'flipOutY', reverse:true}}">
									<ul class="texts">
										<li>We Love Outdoors</li>
										<li>We Love People</li>
										<li>We Are You</li>
										<li>We Care for Nature</li>
										<li>We Challenge Ourselves</li>
									</ul>
								</div>
								<h1 class="heading text-right">TreksandTracks</h1>
								<p class="text-right title highlight">
									Our Treks and Tracks guides were fabulous! They were incredibly knowledgeable and skilled, super nice and friendly, and very helpful in instructing me about rock climbing. I had a great experience and would definitely go back. Also, they provided all of the gear, including shoes, which was great.
                                    </p>
								<p class="text-right">
                                <a href="#work" class="button background-75-c heading-c border-heading-c">Our Activities</a></p>
                                <a href="#about" class="button background-75-f heading-f border-heading-d">About Us</a>
							</div>
						</div>
					</div>
				</div>
		...
		<section id="about">
			<div class="view">
				<img alt class="bg" src="<?php echo base_url()?>Theme/theme-viki/images/placeholders/1920x1200-2.jpg" />
			...
			<div class="view" id="how-we-work">
				<img alt class="bg" src="<?php echo base_url()?>Theme/theme-viki/images/placeholders/1920x1200-2.jpg" /><img alt class="bg" src="<?php echo base_url()?>Theme/theme-viki/images/placeholders/1920x1200-0.jpg" />
		...
		<section id="team">
			<div class="view">
				<img alt class="bg" src="<?php echo base_url()?>Theme/theme-viki/images/placeholders/1920x1200-1.jpg" /><img alt class="bg" src="<?php echo base_url()?>Theme/theme-viki/images/placeholders/1920x1200-2.jpg" />
				<div class="content colors-e">
					<div class="container">
						<h2>Team</h2>
						...
						<div class="row">
							<div class="col-md-3 col-sm-6  col-xs-6">
								<div class="hover-overlay">
									<img alt="Mike Johnson" src="<?php echo base_url()?>Theme/theme-viki/images/placeholders/380x573-1.jpg" title="Mike Johnson" class="fluid-width">
							...
							<div class="col-md-3 col-sm-6  col-xs-6">
								<div class="hover-overlay">
									<img alt="Jessica Specter" src="<?php echo base_url()?>Theme/theme-viki/images/placeholders/380x573-1.jpg" title="Jessica Specter" class="fluid-width">
									<div class="overlay background-90-b">
										<div>
											<p class="text-center text-uppercase heading-b">
							...
							<div class="col-md-3 col-sm-6  col-xs-6">
								<div class="hover-overlay">
									<img alt="Lynda Smith" src="<?php echo base_url()?>Theme/theme-viki/images/placeholders/380x573-1.jpg" title="Lynda Smith" class="fluid-width">
									<div class="overlay background-90-b">
										<div>
											<p class="text-center text-uppercase heading-b">
		...
		<section id="services">
			...
			<div class="view">
				<img alt class="bg" src="<?php echo base_url()?>Theme/theme-viki/images/placeholders/1920x1200-2.jpg" /><img alt class="bg" src="<?php echo base_url()?>Theme/theme-viki/images/placeholders/1920x1200-0.jpg" /><img alt class="bg" src="<?php echo base_url()?>Theme/theme-viki/images/placeholders/1920x1200-1.jpg" />
		...
		<section id="work">
			<div class="view">
				...
				<!--<a onClick="xajax_getProducts(<?= $style->style_id ?>);return false;"><?= $style->name ?>  </a> &bull;-->
									<li><a class="hover-effect" data-group="<?= $style->name ?>" href="#"><?= $style->name ?> </a></li>
				<? endforeach; endif ?>
					...
					<? $picture = base_url() . CLASSES_IMAGE_DIR . strtoupper($row->code) . '/' . strtoupper($row->code) . '1.jpg' ; ?>
									...
									<div class="item col-md-3 col-sm-4 col-xs-6" data-groups='["photography", "web", "video"]'>
										<a href="#!portfolio-item-2.html" class="hover-overlay">
											<img alt="Project 2" src="<?php echo base_url() ?>Theme/theme-viki/images/placeholders/500x400-0.jpg>" width = 500 height="400"/>
...
<!--									<div class="item col-md-3 col-sm-4 col-xs-6" data-groups='["photography", "design"]'>
										<a href="#!portfolio-item-3.html" class="hover-overlay">
											<img alt="Project 3" src="<?php echo base_url()?>Theme/theme-viki/images/placeholders/500x400-0.jpg" />
											<div class="overlay background-90-e">
												<div class="hidden-xs">
									...
									<div class="item col-md-3 col-sm-4 col-xs-6" data-groups='["photography", "web", "video"]'>
										<a href="#!portfolio-item-4.html" class="hover-overlay">
											<img alt="Project 4" src="<?php echo base_url()?>Theme/theme-viki/images/placeholders/500x400-1.jpg" />
											<div class="overlay background-90-e">
												<div class="hidden-xs">
									...
									<div class="item col-md-3 col-sm-4 col-xs-6" data-groups='["photography", "design"]'>
										<a href="#!portfolio-item-5.html" class="hover-overlay">
											<img alt="Project 5" src="<?php echo base_url()?>Theme/theme-viki/images/placeholders/500x400-2.jpg" />
											<div class="overlay background-90-e">
												<div class="hidden-xs">
													<p class="title heading-e">Slider</p>
													<p class="text-center heading-e"><strong>Excepteur sint lorem ipsum dolor sit amet consectetur.</strong></p>
									...
									<div class="item col-md-3 col-sm-4 col-xs-6" data-groups='["photography", "web", "design"]'>
										<a href="#!portfolio-item-6.html" class="hover-overlay">
											<img alt="Project 6" src="<?php echo base_url()?>Theme/theme-viki/images/placeholders/500x400-0.jpg" />
											<div class="overlay background-90-e">
												<div class="hidden-xs">
									...
									<div class="item col-md-3 col-sm-4 col-xs-6" data-groups='["design", "video", "web"]'>
										<a href="#!portfolio-item-7.html" class="hover-overlay">
											<img alt="Project 7" src="<?php echo base_url()?>Theme/theme-viki/images/placeholders/500x400-1.jpg" />
											<div class="overlay background-90-e">
												<div class="hidden-xs">
													<p class="title heading-e">Vimeo Video</p>
													<p class="text-center heading-e"><strong>Excepteur sint lorem ipsum dolor sit amet consectetur.</strong></p>
									...
									<div class="item col-md-3 col-sm-4 col-xs-6" data-groups='["web"]'>
										<a href="#!portfolio-item-8.html" class="hover-overlay">
											<img alt="Project 8" src="<?php echo base_url()?>Theme/theme-viki/images/placeholders/500x400-2.jpg" />
											<div class="overlay background-90-e">
												<div class="hidden-xs">
													<p class="title heading-e">Image</p>
													<p class="text-center heading-e"><strong>Excepteur sint lorem ipsum dolor sit amet consectetur.</strong></p>
									...
									<div class="item col-md-3 col-sm-4 col-xs-6" data-groups='["photography", "design", "video", "web"]'>
										<a href="#!portfolio-item-9.html" class="hover-overlay">
											<img alt="Project 9" src="<?php echo base_url()?>Theme/theme-viki/images/placeholders/500x400-0.jpg" />
											<div class="overlay background-90-e">
												<div class="hidden-xs">
													<p class="title heading-e">YouTube Video</p>
													<p class="text-center heading-e"><strong>Excepteur sint lorem ipsum dolor sit amet consectetur.</strong></p>
									...
									<div class="item col-md-3 col-sm-4 col-xs-6" data-groups='["photography", "design"]'>
										<a href="#!portfolio-item-10.html" class="hover-overlay">
											<img alt="Project 10" src="<?php echo base_url()?>Theme/theme-viki/images/placeholders/500x400-1.jpg" />
											<div class="overlay background-90-e">
												<div class="hidden-xs">
													<p class="title heading-e">Vimeo Video</p>
													<p class="text-center heading-e"><strong>Excepteur sint lorem ipsum dolor sit amet consectetur.</strong></p>
									...
									<div class="item col-md-3 col-sm-4 col-xs-6" data-groups='["photography", "web"]'>
										<a href="#!portfolio-item-11.html" class="hover-overlay">
											<img alt="Project 11" src="<?php echo base_url()?>Theme/theme-viki/images/placeholders/500x400-2.jpg" />
											<div class="overlay background-90-e">
												<div class="hidden-xs">
													<p class="title heading-e">Image</p>
													<p class="text-center heading-e"><strong>Excepteur sint lorem ipsum dolor sit amet consectetur.</strong></p>
									...
									<div class="item col-md-3 col-sm-4 col-xs-6" data-groups='["web", "design"]'>
										<a href="#!portfolio-item-12.html" class="hover-overlay">
											<img alt="Project 12" src="<?php echo base_url()?>Theme/theme-viki/images/placeholders/500x400-0.jpg" />
											<div class="overlay background-90-e">
												<div class="hidden-xs">
													<p class="title heading-e">Slider</p>
													<p class="text-center heading-e"><strong>Excepteur sint lorem ipsum dolor sit amet consectetur.</strong></p>
...
-->							</div>
		...
		<section id="contact">
			<div class="view">
				<img alt class="bg" src="<?php echo base_url()?>Theme/theme-viki/images/placeholders/1920x1200-1.jpg" /><img alt class="bg" src="<?php echo base_url()?>Theme/theme-viki/images/placeholders/1920x1200-2.jpg" /><img alt class="bg" src="<?php echo base_url()?>Theme/theme-viki/images/placeholders/1920x1200-0.jpg" />
		...
		<footer class="colors-g page-transition">
					...
					<div class="col-md-3">
						...
						<div class="photo">
							<div class="col-xs-3 col-sm-2 col-md-4">
								<a target="_blank" href="https://www.flickr.com/photos/we-are-envato/12333983853" title="Melbourne Meetup by Envato, on Flickr"><img class="fluid-width" src="<?php echo base_url()?>Theme/theme-viki/images/placeholders/150x150-1.jpg" alt="Melbourne Meetup"></a>
							</div>
							<div class="col-xs-3 col-sm-2 col-md-4">
								<a target="_blank" href="https://www.flickr.com/photos/we-are-envato/13090549273" title="Around the Envato Office - Highfive! by Envato, on Flickr"><img class="fluid-width" src="<?php echo base_url()?>Theme/theme-viki/images/placeholders/150x150-2.jpg" alt="Around the Envato Office - Highfive!"></a>
							</div>
							<div class="col-xs-3 col-sm-2 col-md-4">
								<a target="_blank" href="https://www.flickr.com/photos/we-are-envato/12333834195" title="Melbourne Meetup by Envato, on Flickr"><img class="fluid-width" src="<?php echo base_url()?>Theme/theme-viki/images/placeholders/150x150-1.jpg" alt="Melbourne Meetup"></a>
							</div>
							<div class="col-xs-3 col-sm-2 col-md-4">
								<a target="_blank" href="https://www.flickr.com/photos/we-are-envato/13090422515" title="Around the Envato Office - Becca by Envato, on Flickr"><img class="fluid-width" src="<?php echo base_url()?>Theme/theme-viki/images/placeholders/150x150-2.jpg" alt="Around the Envato Office - Becca"></a>
							</div>
							<div class="col-xs-3 col-sm-2 col-md-4">
								<a target="_blank" href="https://www.flickr.com/photos/we-are-envato/13090762874" title="Around the Envato Office - Ben &amp; Jane by Envato, on Flickr"><img class="fluid-width" src="<?php echo base_url()?>Theme/theme-viki/images/placeholders/150x150-1.jpg" alt="Around the Envato Office - Ben &amp; Jane"></a>
							</div>
							<div class="col-xs-3 col-sm-2 col-md-4">
								<a target="_blank" href="https://www.flickr.com/photos/we-are-envato/13090456565" title="Around the Envato Office - Selina by Envato, on Flickr"><img class="fluid-width" src="<?php echo base_url()?>Theme/theme-viki/images/placeholders/150x150-2.jpg" alt="Around the Envato Office - Selina"></a>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="bottom text-center background-10-b">
				© 2015 All Rights Reserved. <a href="#" class="open-overlay-window heading" data-overlay-window=".credits-overlay">Credits.</a>
			</div>
		</footer>
		<!-- END: Footer -->
		<script>
