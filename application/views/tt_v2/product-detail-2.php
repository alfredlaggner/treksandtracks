                            ...
                            <div class="tab-content">
                                <div id="photos-tab" class="tab-pane fade in active">
                                    <div class="photo-gallery style1" data-animation="slide" data-sync="#photos-tab .image-carousel">
                                        <ul class="slides">
			<? $i=1; foreach ($pictures as $picture) : ?>
...
We suggest that you contact the host to confirm availability and rates before submitting a reservation request.
                                    ...
                                    <div class="room-list listing-style3 hotel">
                                        <article class="box">
                                            <figure class="col-sm-4 col-md-3">
                                                <a class="hover-effect popup-gallery" href="../../../travelo/ajax/slideshow-popup.html" title=""><img width="230" height="160" src="http://placehold.it/230x160" alt=""></a>
                                            </figure>
                                            <div class="details col-xs-12 col-sm-8 col-md-9">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="action-section">
                                                        <a href="../../../travelo/hotel-booking.html" title="" class="button btn-small full-width text-center">BOOK NOW</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </article>
                                        <article class="box">
                                            <figure class="col-sm-4 col-md-3">
                                                <a class="hover-effect popup-gallery" href="<?= base_url() ?>travelo/ajax/slideshow-popup.html" title=""><img width="230" height="160" src="http://placehold.it/230x160" alt=""></a>
                                            </figure>
                                            <div class="details col-xs-12 col-sm-8 col-md-9">
                                                <div>
                                                    <div>
                    ...
                    <div class="sidebar col-md-3">
                        <article class="detailed-logo">
                            ...
                            <div class="details">
                                <h2 class="box-title"><?= $row->name ?><small><i class="soap-icon-departure yellow-color"></i><span class="fourty-space"><?= $row->slogan ?></span></small></h2>
                                ...
                                href="<?= site_url() . 'tt_v2/product_booking1/' . $row->activity_id ?>">order now</a>
                            </div>
                        </article>
                        <div class="travelo-box contact-box">
                            <h4>Need Help?</h4>
                            <p>We would be more than happy to help you. Our team advisors are at your service to help you.</p>
...
<? $picture = base_url() . CLASSES_IMAGE_DIR . strtoupper($related->code) . '/' . $related->picture ; ?>
                                ...
                                <article class="box">
                                    ...
                                    <div class="details">
                                        <h5 class="box-title"><a href="<?= site_url() . "tt_v2/product/" . $related->activity_id . '/photos_tab' ?>"><?= $related->name ?></a></h5>
...
<? endforeach ?>
    ...
    <script type="text/javascript" src="<?= base_url() . COMPONENTS_DIR ?>components/flexslider/jquery.flexslider-min.js"></script>
