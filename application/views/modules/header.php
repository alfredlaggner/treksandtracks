...
<head>
	...
	<title>Admin</title>
	<script type="text/javascript" src="<?php base_url() ?>js/jquery-1.3.2.js"></script>
	<script type="text/javascript" src="<?php base_url() ?>js/ui/ui.core.js"></script>
	<script type="text/javascript" src="<?php base_url() ?>js/superfish.js"></script>
	<script type="text/javascript" src="<?php base_url() ?>js/live_search.js"></script>
	<script type="text/javascript" src="<?php base_url() ?>js/tooltip.js"></script>
	<script type="text/javascript" src="<?php base_url() ?>js/cookie.js"></script>
	<script type="text/javascript" src="<?php base_url() ?>js/ui/ui.sortable.js"></script>
	<script type="text/javascript" src="<?php base_url() ?>js/ui/ui.draggable.js"></script>
	<script type="text/javascript" src="<?php base_url() ?>js/ui/ui.resizable.js"></script>
	<script type="text/javascript" src="<?php base_url() ?>js/ui/ui.dialog.js"></script>
	<script type="text/javascript" src="<?php base_url() ?>js/custom.js"></script>

	<link href="<?php base_url() ?>css/ui/ui.base.css" rel="stylesheet" media="all"/>

	<link href="<?php base_url() ?>css/themes/apple_pie/ui.css" rel="stylesheet" title="style" media="all"/>
...
<div id="page_wrapper">
	<div id="page-header">
		<div id="page-header-wrapper">
			<div id="top">
				<a href="dashboard" class="logo" title="Trecks and Tracks">Trecks and Tracks Administrator</a>
				<div class="welcome">
					...
					<ul>
						...
						<li>
							...
							<ul id="style-switcher">
								<li>
									<a class="set_theme" id="black_rose" href="#" title="Black Rose Theme">Black Rose
										Theme</a>
								</li>
								<li>
									<a class="set_theme" id="gray_standard" href="#" title="Gray Standard Theme">Gray
										Standard Theme</a>
								</li>
								<li>
									<a class="set_theme" id="gray_lightness" href="#" title="Gray Lightness Theme">Gray
										Lightness Theme</a>
								</li>
								<li>
									<a class="set_theme" id="apple_pie" href="#" title="Apple Pie Theme">Apple Pie
										Theme</a>
								</li>
								<li>
									<a class="set_theme" id="blueberry" href="#" title="Blueberry Theme">Blueberry
										Theme</a>
								</li>
							</ul>
						</li>
