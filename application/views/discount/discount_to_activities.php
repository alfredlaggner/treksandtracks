...
<div id="page-content">
	<div id="page-content-wrapper">
		...
		<? endif; ?>
			...
			<div class="hastable">
					...
					<input type="submit" name="<?= $cancel_name ?>" value="Cancel" class="ui-state-default float-right ui-corner-all ui-button" />
					<input type="submit" name="<?= $return_name ?>" value="Assign & Return" class="ui-state-default float-right ui-corner-all ui-button" />
					<input type="submit" name="assign" value="Assign" class="ui-state-default float-right ui-corner-all ui-button" />
					<table id="sort-table">
						<thead>
							<tr>
								<th>
								<input type="checkbox" value="check_none" onclick="this.value=check(this.form.list)" class="submit"/>
								</th>
								<th>Code</th>
								<th>Name</th>
								<th>Description</th>
	...
	<?	if(isset($activities)) : foreach($activities as $activity) : ?>
						...
						<tbody>
							<tr>
								<input type="hidden" value="<?= $activity->activity_id; ?>" name="activity_id<?= $i  ?>" id="activity_id<?= $i  ?>" />
