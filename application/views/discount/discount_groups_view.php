...
<div id="page-content">
	<div id="page-content-wrapper">
		...
		<? endforeach; ?>
		<? endif; ?>
							<td><a class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="Show Discounts" href="<?= site_url().'discount/group_discount_show/1/' ?> <?= $row->name ; ?> "> <span class="ui-icon ui-icon-wrench"></span> </a> 

<a class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="Copy Discounts" href="<?= site_url().'discount/group_discount_copy/' ?><?= $row->name; ?>"> <span class="ui-icon ui-icon-plus"></span> </a>

							
<a class="btn_no_text btn ui-state-default ui-corner-all tooltip confirmClick" title="Delete Discounts" href="<?= site_url().'discount/group_discount_delete/' ?><?= $row->name ?>"> <span class="ui-icon ui-icon-trash"></span> </a>
