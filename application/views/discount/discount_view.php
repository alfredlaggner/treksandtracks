...
<div id="sub-nav">
		<div class="page-title">
				<h1><?= $title ?></h1>
				<span><a href="#" title="Home">Home</a> > <a href="#" title="Dashboard">Dashboard</a> > <?= anchor('discount', 'Discount Overview'); ?> > <?= $title_action ?></span> </div>
...
<li>
		...
		<input type="text" name="promo_code" id="promo_code"  class="text"  value='<?= $row->promo_code ?>' />
</li>
<li>
...
<li>
		...
		<input type="text" name="amount" id="amount"  class="number required text"  value='<?= $row->amount ?>' />
</li>
<li>
...
<li>
		...
		<option selected value="<?= $discount_type->type; ?>"><?= $discount_type->name. ' - ' ?> <?= $discount_type->description; ?></option>
		<? else : ?>
		<option          value="<?= $discount_type->type; ?>"><?= $discount_type->name . ' - ' ?> <?= $discount_type->description; ?></option>
		<? endif; ?>
		<? endforeach; ?>
		<? endif; ?>
		</select>
...
--><li>
		...
		<input type="text" name="exp_date" id="exp_date"  class="text" value='<?= $row->exp_date ?>'  />
</li>
<!--<li>
