...
<div id="page-content">
	<div id="page-content-wrapper">
		...
		<? endforeach; ?>
		<? endif; ?>
							<td><a class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="Edit Discount" href="<?= site_url().'discount/discount_view/' ?><?= $row->discount_id; ?>"> <span class="ui-icon ui-icon-wrench"></span> </a> 

<a class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="Assign Activities" href="<?= site_url().'discount/assign_activities/' ?><?= $row->discount_id; ?>"> <span class="ui-icon ui-icon-plus"></span> </a>

							
<a class="btn_no_text btn ui-state-default ui-corner-all tooltip confirmClick" title="Delete Discount" href="<?= site_url().'discount/discount_delete/' ?><?= $row->discount_id ?>"> <span class="ui-icon ui-icon-trash"></span> </a>
