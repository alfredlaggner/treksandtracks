			...
			<div id="inputform">
				<table border="0">
					<?php echo form_open('rate/add_rate')?>
						<td><input type="hidden" name="rate_plan_id" id="rate_plan_id" class="text"  value='<?php echo $rate_plan_id ?>' /></td>
					<tr>
						<td>Name</td>
					...
					<tr>
						...
						<td><input type="text" name="status_dependent_text" id="status_dependent_text" class="text"  value=''/></td>
					</tr>
					<tr>
						<td>Minimum Age</td>
					...
					<tr>
						...
						<td><input type="text" name="party_size_min" id="party_size_min" class="text"  value=''/></td>
					</tr>
					<tr>
						<td>Maximum Party Size</td>
						<td><input type="text" name="party_size_max" id="party_size_max" class="text" value='' /></td>
					</tr>
					<tr>
						<td>Active</td>
