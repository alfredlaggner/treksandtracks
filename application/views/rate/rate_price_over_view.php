...
<div id="sub-nav">
	<div class="page-title">
		...
		<span><a href="#" title="Home">Home</a> > <a href="#" title="Dashboard">Dashboard</a> > <?php echo anchor('rate', 'Rate Overview'); ?> > <?php echo $title_action ?></span> </div>
...
<div id="page-layout">
	...
	<div class="content-box">
		<div id="inputform">
<h3>Event Rates for <?php echo $activity_name ?></h3>						
			<ul>
			...
			<p style="float:right";>
				<?php  echo anchor('activity_rate/rate_price_create_view/'.$activity_id, 'Add Effective Date')?>
			</p>
					...
					<table id="sort-table">
						...
						<td class="center"><input type="checkbox" value="1" name="list" class="checkbox"/></td>
							...
							echo $weekend;
							 ...
							 ?></td>
							<td><?php echo $rate_price->exp_discount_price; ?></td>
							
							<td><a class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="Edit Rate Price" href="<?php echo site_url().'activity_rate/rate_price_view/'. $rate_price->rate_price_id . '/' .$activity_id  ?>"> <span class="ui-icon ui-icon-wrench"></span> </a> <a class="btn_no_text btn ui-state-default ui-corner-all tooltip confirmClick" title="Delete Rate Price" href="<?php echo site_url().'activity_rate/delete_rate_price/'. $rate_price->rate_price_id . '/' .$activity_id  ?>"> <span class="ui-icon ui-icon-trash"></span> </a></td>							</tr>
