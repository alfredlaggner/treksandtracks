		...
		<div class="content-box">
			<div id="inputform">
				<ul>
					...
					<input type="hidden" name="rate_plan_id" id="rate_plan_id" class="text"  value='<?php echo $rate_plan_id ?>' />
					<li>
						<label>Name</label>
...
//						echo form_checkbox('is_status_dependent',$data) ?>
					...
					<li>
						...
						<input type="text" name="status_dependent_text" id="status_dependent_text" class="text"  value=''/>
					</li>
					<li>
