				...
				<form name="myform" class="pager-form" method="post" action="">
					<table id="sort-table">
						...
						<td class="center"><input type="checkbox" value="1" name="list" class="checkbox"/></td>
							...
							<td><a class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="Edit Rate Price" href="<?php echo site_url().'rate/rate_price_view/'. $rate_price->rate_price_id . '/' .$activity_id  ?>"> <span class="ui-icon ui-icon-wrench"></span> </a> <a class="btn_no_text btn ui-state-default ui-corner-all tooltip confirmClick" title="Delete Rate Price" href="<?php echo site_url().'rate/delete_rate_price/'. $rate_price->rate_price_id . '/' .$activity_id  ?>"> <span class="ui-icon ui-icon-trash"></span> </a></td>							</tr>
