				...
				<form name="myform" class="pager-form" method="post" action="">
					<table id="sort-table">
						...
						<tr>
							...
							<td><a class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="Edit Rate Plan" href="<?php echo site_url().'rate/rate_plan_view/' ?><?php echo $row->rate_plan_id; ?>"> <span class="ui-icon ui-icon-wrench"></span> </a>  
							
							<a class="btn_no_text btn ui-state-default ui-corner-all tooltip confirmClick" title="Delete Rate Plan" href="<?php echo site_url().'rate/delete_rate_plan/' ?><?php echo $row->rate_plan_id; ?>"> <span class="ui-icon ui-icon-trash"></span> </a></td>
						</tr>
