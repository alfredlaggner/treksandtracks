...
<div id="sub-nav">
	<div class="page-title">
		...
		<span><a href="#" title="Home">Home</a> > <a href="#" title="Dashboard">Dashboard</a> > <?php echo anchor('rate', 'Rate Price Overview'); ?> > <?php echo $title_action ?></span> </div>
		...
		<div id="page-content-wrapper">
			...
			<div class="content-box">
				...
				<div id="inputform"> <?php $attributes = array('id' => 'rate'); 
					...
					<table>
								<td><input type="hidden" name="activity_id" id="activity_id"  value='<?php echo $row->activity_id ?>' /></td>
							<tr>
							<tr>
								<td>Effective Date </td>
								<td><input type="text" name="effective_date" id="effective_date"  class="text"  value='<?php echo $row->effective_date ?>' /></td>
							</tr>
								<td>Wholesale Price </td>
								<td><input type="text" name="wholesale_price" id="wholesale_price"  class="text"  value='<?php echo $row->wholesale_price ?>'/></td>
							</tr>
							</tr>
								<td>Price </td>
								<td><input type="text" name="price" id="price"  class="text"  value='<?php echo $row->price ?>'/></td>
							</tr>
							<tr>
								<td>Expired Discount Price </td>
								<td><input type="text" name="exp_discount_price" id="exp_discount_price"  class="text" value='<?php echo $row->exp_discount_price ?>'/> /></td>
							</tr>
							<tr>
								<td>Weekend Price </td>
								<td><input type="text" name="price_weekend" id="price_weekend"  class="text"  value='<?php echo $row->price_weekend ?>'/></td>
							</tr>
