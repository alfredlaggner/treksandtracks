...
<?php	if(isset($activities)) : foreach($activities as $row) : ?>
					...
					<tbody>
						<tr>
							<input type="hidden" value="<?php echo $row->gear_id; ?>" name="gear_related_id<?php echo  $i  ?>" id="gear_related_id<?php echo  $i  ?>" />
...
<?php endforeach; endif; ?>
				...
				<input type="submit" name="assign_gear" value="Assign Gear" class="ui-state-default float-right ui-corner-all ui-button" />
						</tr>
				</table>
				</form>
				<i class="note"></i> </div>
