			...
			<div id="capslide_img_cont<?= $i ?>" class="sg-8 collection-product  ic_container "> <a  class="collection-product-thumb" href="<?= site_url() . "tt2/gear/" . $gear->gear_id ?>"><img  src="<?= $picture ?> " height="223" width="223" alt="product title" />
