...
<? endforeach; endif ?>
			...
			<div id="product_display">
				...
				<div id="capslide_img_cont<?= $i ?>" class="sg-8 collection-product  ic_container "> <a  class="collection-product-thumb" href="<?= site_url() . "tt_v1/product/" . $row->activity_id ?>"><img  src="<?= $picture ?> " height="223" width="223" alt="product title" />
