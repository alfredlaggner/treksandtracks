...
<div class="page-title-container">
	<div class="container">
		<div class="page-title pull-left">
			<h2 class="entry-title">Enter Student Information</h2>
		</div>
		<ul class="breadcrumbs pull-right">
			...
			<li><a href="#">HOME</a></li>
			<li class="active">Enter Student Information</li>
		</ul>
	</div>
</div>
					...
					<div class="person-information">
						...
						<div class="row">
							<div class="form-group col-sm-6 col-md-5">
								...
								<input type="text" class="input-text full-width validate[required]" name="first_name<?= $i ?>" id="first_name<?= $i ?>" value="" placeholder="First Name"/>
								<? else : ?>
							...
							<div class="form-group col-sm-6 col-md-5">
								...
								<input type="text" class="input-text full-width validate[required]" name="last_name<?= $i ?>" id="last_name<?= $i ?>" value="" placeholder="Last Name" />
								<? else : ?>
						...
						<div class="row">
							<div class="form-group col-sm-6 col-md-5">
								...
								<input type="text" class="input-text full-width validate[required,custom[email]]" name="email<?= $i ?>" id="email<?= $i ?>" value="" placeholder="Last Name" />
								<? else : ?>
								<label>email address</label>
								<input type="text" class="input-text full-width" name="email<?= $i ?>" id="email<?= $i ?>" value="" placeholder="Last Name" />
								<? endif ?>
							</div>
						</div>
						<div class="row">
