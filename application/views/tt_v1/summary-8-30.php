...
$reschedule_rules = "If a scheduling conflict arises and you need to reschedule, we are happy to reactivate your voucher. If a reschedule is requested within 10 days prior to your class, a fee will apply ( $25 for rock climbing, $40 for backpacking).";	
...
-->
			...
			<input title= '<?= $reschedule_rules ?>' type='submit' value='<?= $label; ?>' class="submit" />
			</li>
			</ul>
		</form>
	</div>
...
<div class="sg-15">
	...
	<? $reschedule_rules = "If a scheduling conflict arises and you need to reschedule, we are happy to reactivate your voucher. If a reschedule is requested within 10 days prior to your class, a $25 fee will apply.";	?>
		<div id="customer_data">
			<input  title= '<?= $reschedule_rules ?>' type="submit" value="CONFIRM" class="submit" />
		</div>
		</form>
	</div>
</div>
