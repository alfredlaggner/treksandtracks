                    ...
                    <div class="sidebar col-md-3">
                        <article class="detailed-logo">
                            ...
                            <div class="details">
                                ...
                                href="<?= site_url() . 'tt_v1/product_booking1/' . $row->activity_id ?>">order now</a>
                            </div>
                        </article>
...
<? $picture = base_url() . CLASSES_IMAGE_DIR . strtoupper($related->code) . '/' . $related->picture ; ?>
                                ...
                                <article class="box">
                                    ...
                                    <div class="details">
                                        <h5 class="box-title"><a href="<?= site_url() . "tt_v1/product/" . $related->activity_id . '/photos_tab' ?>"><?= $related->name ?></a></h5>
