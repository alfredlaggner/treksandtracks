...
jQuery(function($){
   ...
   $("#emergency_phone<?= $i ?>").mask("(999) 999-9999");
		...
		<div id="customer_data">
				...
				<input type="hidden" name="date" id="date"  class="text" readonly  value='<?  echo $event['event_date'] ?>'  />
				<input type="hidden" name="time" id="time"  class="text" readonly  value='<?= $event['event_time'] ?>'  />
				<input type="hidden" name="duration" id="duration"  class="text" readonly  value='<?  echo $event['duration'] ?>'  />
				<input type="hidden" name="instructor" id="instructor"  class="text" readonly  value='
							<?	$event['instructor'] = $this->event_to_employee_model->get_employee_string($event['event_event_id']); echo $event['instructor'] ?>'  />
				<input type="hidden" name="price" id="price"  class="text" readonly  value='<?  echo $event['rate_price'] ?>'  />
				<input type="hidden" name="exp_discount_price" id="exp_discount_price"  class="text" readonly  value='<?  echo $event['exp_discount_price'] ?>'  />
				<input type="hidden" name="discount" id="discount"  class="text" readonly  value='<?= $event['discount'] ?>'  />
				<input type="hidden" name="tax" id="tax"  class="text" readonly  value='<?= $event['tax'] ?>'  />
				<input type="hidden" name="available" id="available"  class="text" readonly  value='<?= $event['available']; ?>' />
				<input type="hidden" name="attending" id="attending"  class="text" readonly  value='<?= $event['attending']; ?>' />
				<?
...
-->
						...
						<div style="float:left">
								...
								<input type="text" class="text validate[required]" size="14" name="first_name<?= $i ?>" id="first_name<?= $i ?>" value="">
								</input>
						</div>
						<? else : ?>
						<div style="float:left">
								<label>First Name</label>
								<input type="text" class="text" size="14" name="first_name<?= $i ?>" id="first_name<?= $i ?>" value="">
								</input>
						</div>
						<? endif ?>
						<div>
								...
								<input type="text" class="text validate[required]" size="14" name="last_name<?= $i ?>" id="last_name<?= $i ?>" value="">
								</input>
								<? else : ?>
...
-->
						<div style="float:left" >
								...
								<input type="email" class="text validate[required,custom[email]]" size="26" name="email<?= $i ?>" id="email<?= $i ?>" value="">
								</input>
								<? else : ?>
								<label>Email<span></span></label>
								<input type="email" class="text" size="26" name="email<?= $i ?>" id="email<?= $i ?>" value="">
								</input>
								<? endif ?>
						</div>
						<div>
								...
								<input type="text" class="text validate[required]" size="12" name="cell<?= $i ?>"  id="cell<?= $i ?>" value="">
								</input>
								<? else : ?>
								<label>Phone</label>
								<input type="text" class="text" size="12" name="cell<?= $i ?>"  id="cell<?= $i ?>" value="">
								</input>
								<? endif ?>
						</div>
						<!--						</div>
						...
						<fieldset>
								<div style="float:left">
										...
										<input type="text" class="text" size="26" name="emergency_contact<?= $i ?>" id="emergency_contact<?= $i ?>" value="">
										</input>
								</div>
								<div>
										<label>Emergency Phone<span> </span></label>
										<input type="text" class="text" size="12" name="emergency_phone<?= $i ?>" id="emergency_phone<?= $i ?>" value="">
										</input>
								</div>
						</fieldset>
				</div>
...
-->
						<div style="float:left">
								<label>Address</label>
								<input type="text" class="text" size="26" name="address1<?= $i ?>" id="address1<?= $i ?>" value="">
								</input>
						</div>
						<div>
								<? if ($i==1) : ?>
								<label>City<span> *</span></label>
								<input type="text" class="text validate[required]" size="15" name="city<?= $i ?>" id="city<?= $i ?>" value="">
								</input>
								<? else : ?>
								<label>City</label>
								<input type="text" class="text" size="15" name="city<?= $i ?>" id="city<?= $i ?>" value="">
								</input>
								<? endif ?>
						</div>
						<!--            </fieldset>
-->
						<fieldset>
								<div>
										<label>State</label>
										<input type="text"  class="text" size="4" name="state<?= $i ?>"  id="state<?= $i ?>" value="CA">
										</input>
								</div>
								<div>
								...
								<div>
										<label>Country</label>
										<input type="text" class="text" size="" name="country<?= $i ?>" id="country<?= $i ?>" value="USA">
										</input>
								</div>
						</fieldset>
				</div>
...
#new_line, #customer_data li { width:100%}
				...
				<div id="customer_data">
						...
						<div id="left">
								...
								<fieldset>
										...
										<label for= "is_questionaire<?= $i?>"  id="somelabel" >Please check if you accept!</label>
								</fieldset>
								<fieldset>
										<div>
				...
				?>
								...
								<fieldset>
										...
										<div id = "new_line">
												...
												<label  for="have_sleeping_bag<?= $i?>" id="somelabel">Bring a sleeping bag </label>
										</div>
										<div id = "new_line">
												<? $data = [ 'id' => 'have_sleeping_pad' . $i, 'class' => 'wb']; ?>
												<?= form_checkbox('have_sleeping_pad' . $i, 'no', FALSE, $data) ?>
												<label  for="have_sleeping_pad<?= $i?>" id="somelabel">Bring a sleeping pad </label>
										</div>
								</fieldset>
								...
								<fieldset>
										...
										<div id = "new_line">
												...
												<label  for="breakfast_hot_chocolate<?= $i?>" id="somelabel">Hot Chocolate</label>
										</div>
										<div id = "new_line">
						...
						<div id= "right">
								...
								<fieldset>
										<div id = "new_line">
												...
												<label for= "is_asthma<?= $i?>"  id="somelabel" >Asthma/respiratory Illness </label>
										</div>
										<div id = "new_line">
												<? $data = [ 'id' => 'is_inhaler' . $i, 'class' => 'wb']; ?>
												<?= form_checkbox('is_inhaler' . $i, 'no', FALSE, $data) ?>
												<label for= "is_inhaler<?= $i?>" id="somelabel">If yes, do you carry an inhaler?</label>
										</div>
										<div id = "new_line">
										...
										<div id = "new_line">
												...
												<label for="is_cardio_disease<?= $i?>"  id="somelabel">Cardiovascular disease </label>
										</div>
										<div id = "new_line">
												<? $data = [ 'id' => 'is_hypertension' . $i, 'class' => 'wb']; ?>
												<?= form_checkbox('is_hypertension' . $i, 'no', FALSE, $data) ?>
												<label for="is_hypertension<?= $i?>"  id="somelabel">High blood pressure </label>
										</div>
										<div id = "new_line">
												<? $data = [ 'id' => 'is_knee_ankle_shoulder' . $i, 'class' => 'wb']; ?>
												<?= form_checkbox('is_knee_ankle_shoulder' . $i, 'no', FALSE, $data) ?>
												<label  for="is_knee_ankle_shoulder<?= $i?>" id="somelabel">Joint (hip, knee, ankle, shoulder etc.) or back injuries (including sprains)</label>
										</div>
										<div id = "new_line">
												<? $data = [ 'id' => 'is_bleeding' . $i, 'class' => 'wb']; ?>
												<?= form_checkbox('is_bleeding' . $i, 'no', FALSE, $data) ?>
												<label  for="is_bleeding<?= $i?>" id="somelabel">Bleeding or blood disorders </label>
										</div>
										<div id = "new_line">
												<? $data = [ 'id' => 'is_dizziness' . $i, 'class' => 'wb']; ?>
												<?= form_checkbox('is_dizziness' . $i, 'no', FALSE, $data) ?>
												<label  for="is_dizziness<?= $i?>" id="somelabel">Dizziness or fainting episodes </label>
										</div>
										<div id = "new_line">
												<? $data = [ 'id' => 'is_fear_of_heights' . $i, 'class' => 'wb']; ?>
												<?= form_checkbox('is_fear_of_heights' . $i, 'no', FALSE, $data) ?>
												<label  for="is_fear_of_heights<?= $i?>" id="somelabel">Do you have a fear of heights or exposed places?</label>
										</div>
										<div id = "new_line">
												<? $data = [ 'id' => 'is_see_medical_specialist' . $i, 'class' => 'wb']; ?>
												<?= form_checkbox('is_see_medical_specialist' . $i, 'no', FALSE, $data) ?>
												<label  for="is_see_medical_specialist<?= $i?>" id="somelabel">Do you see a medical/physical specialist of any kind</label>
										</div>
										<div>
												<? $data = [ 'id' => 'is_any_other_condition' . $i, 'class' => 'wb']; ?>
												<?= form_checkbox('is_any_other_condition' . $i, 'no', FALSE, $data) ?>
												<label  for="is_any_other_condition<?= $i?>" id="somelabel">Any other condition that would affect your performance or health</label>
										</div>
								</fieldset>
								<fieldset>
										<div>
								...
								<fieldset>
										<div id = "new_line">
												...
												<label  for="is_allergic_medications<?= $i?>"  id="somelabel">Medications </label>
										</div>
										<div id = "new_line">
												<? $data = [ 'id' => 'is_allergic_insect_stings' . $i, 'class' => 'wb']; ?>
												<?= form_checkbox('is_allergic_insect_stings' . $i, 'no', FALSE, $data) ?>
												<label  for="is_allergic_insect_stings<?= $i?>"  id="somelabel">Insect stings (If yes, we strongly recommend that you carry medication.) </label>
										</div>
										<div id = "new_line">
								...
								<fieldset>
										<div id = "new_line">
												...
												<label  for="is_medications<?= $i?>" id="somelabel">Are you currently taking any medications? </label>
										</div>
								</fieldset>
								<fieldset>
										<div>
