...
<? for ($i=1;$i<=$nr_of_students;$i++) : ?>
	...
	-->
			<fieldset>
				...
				<div>
					<label>Any other condition that would affect your performance or health in the backcountry </label>
				<?= form_checkbox('is_any_other_condition' . $i, 'no', FALSE) ?>
				</div>
				<div
					<label>Please explain any yes responses in the space below – including approximate dates and current status.</label>
			...
			<fieldset>
				...
				<div>
					<label>Please explain any yes responses in the space below – including description of allergic response.</label>
			...
			<fieldset>
				...
				<div>
					<label>If yes, please list medication, dosage, and condition for which you are taking the medication:</label>
