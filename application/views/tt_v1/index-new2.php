...
<link rel="stylesheet" href="<?php echo base_url() ?>Theme/theme-viki/bower_components/fontawesome/css/font-awesome.min.css" />
<link rel="stylesheet" href="<?php echo base_url() ?>Theme/theme-viki/bower_components/animate.css/animate.min.css" />
<link rel="stylesheet" href="<?php echo base_url() ?>Theme/theme-viki/bower_components/minicolors/jquery.minicolors.css" />
<link rel="stylesheet" href="<?php echo base_url() ?>Theme/theme-viki/bower_components/slick.js/slick/slick.css" />
<link rel="stylesheet" href="<?php echo base_url() ?>Theme/theme-viki/bower_components/slick.js/slick/slick-theme.css" />
<link rel="stylesheet" href="<?php echo base_url() ?>Theme/theme-viki/bootstrap/dist/css/bootstrap-custom.min.css" />
<link rel="stylesheet" href="<?php echo base_url() ?>Theme/theme-viki/lib/linecons/style.css" />
<link rel="stylesheet" href="<?php echo base_url() ?>Theme/theme-viki/styles/style.min.css" />
<link rel="stylesheet" href="<?php echo base_url() ?>Theme/theme-viki/theme-custom.css" />
<link rel="shortcut icon" href="<?php echo base_url() ?>Theme/theme-viki/favicon.ico" type="image/x-icon" />
<link rel="apple-touch-icon" href="<?php echo base_url() ?>Theme/theme-viki/apple-touch-icon.png" />
<link rel="apple-touch-icon" sizes="57x57" href="<?php echo base_url() ?>Theme/theme-viki/apple-touch-icon-57x57.png" />
<link rel="apple-touch-icon" sizes="72x72" href="<?php echo base_url() ?>Theme/theme-viki/apple-touch-icon-72x72.png" />
<link rel="apple-touch-icon" sizes="76x76" href="<?php echo base_url() ?>Theme/theme-viki/apple-touch-icon-76x76.png" />
<link rel="apple-touch-icon" sizes="114x114" href="<?php echo base_url() ?>Theme/theme-viki/apple-touch-icon-114x114.png" />
<link rel="apple-touch-icon" sizes="120x120" href="<?php echo base_url() ?>Theme/theme-viki/apple-touch-icon-120x120.png" />
<link rel="apple-touch-icon" sizes="144x144" href="<?php echo base_url() ?>Theme/theme-viki/apple-touch-icon-144x144.png" />
<link rel="apple-touch-icon" sizes="152x152" href="<?php echo base_url() ?>Theme/theme-viki/apple-touch-icon-152x152.png" />
</head>
<body class="state1 background-100-e">
<div class="ext-nav background-95-h page-transition">
	<div class="view half-height"> <img alt class="bg static" src="<?php echo base_url() ?>Theme/theme-viki/images/placeholders/1920x1200-1.jpg" />
		<div class="content no-top-padding no-bottom-padding  full-height">
			<div class="container-fluid  full-height">
				<div class="row full-height"> <a href="<?php echo base_url() ?>Theme/theme-viki/blog.html" class="col-md-6 colors-e background-95-e full-height">
					<div> <span class="side-label">All The Latest</span> <span class="side-title">Blog</span> </div>
					</a> <a href="<?php echo base_url() ?>Theme/theme-viki/help.html" class="col-md-6 colors-f background-95-f full-height">
					<div> <span class="side-label">Documentation</span> <span class="side-title">Help</span> </div>
					</a> </div>
			</div>
		</div>
	</div>
	<div class="container-fluid  half-height">
		<div class="row full-height"> <a href="#how-we-work" class="col-md-4 colors-g background-solid full-height border-bottom border-lite">
			<div> <span class="side-label">Awesome</span> <span class="side-title">How We Work</span> </div>
			</a> <a href="#who-we-are" class="col-md-4 colors-g background-solid full-height border-bottom border-left border-lite">
			<div> <span class="side-label">We Are Designers</span> <span class="side-title">Who We Are</span> </div>
			</a> <a href="#numbers" class="col-md-4 colors-g background-solid full-height border-bottom border-left border-lite">
			<div> <span class="side-label">Some Facts</span> <span class="side-title">Our Numbers</span> </div>
			</a> </div>
	</div>
</div>
...
<nav class="navbar navbar-default navbar-fixed-top page-transition colors-e background-solid" role="navigation" id="top-nav">
	<div class="container">
		<div class="navbar-header"> <a class="menu-toggle ext-nav-toggle visible-xs-block" data-target=".ext-nav" href="#"><span></span></a> <a class="menu-toggle navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse" href="#"><span></span></a> <a class="navbar-brand" href="">SKROLL<span class="highlight">EX</span></a> </div>
...
<div class="overlay-window gallery-overlay colors-f background-95-f" data-overlay-zoom="#work .content">
	<div class="overlay-control background-85-d"> <a class="previos" href="#"></a> <a class="next" href="#"></a> <a class="cross" href="#"></a> </div>
...
<div class="overlay-window map-overlay colors-f background-95-f">
	<div class="overlay-control background-90-f"> <a class="cross" href="#"></a> </div>
...
<div class="overlay-window credits-overlay colors-g background-95-g">
	<div class="overlay-control background-85-d"> <a class="cross" href="#"></a> </div>
	<div class="overlay-view">
...
<!-- BEGIN: Page content -->
<section id="home">
	<div class="view"> <img alt class="bg" src="<?php echo base_url() ?>Theme/theme-viki/images/placeholders/1920x1200-0.jpg" /><img alt class="bg" src="<?php echo base_url() ?>Theme/theme-viki/images/placeholders/1920x1200-1.jpg" />
			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-5 col-md-offset-1">
						...
						<p class="text-right title highlight"> Integer ligula ante, posuere et ante quis, eleifend eleifend ipsum. In sed odio mi. Vivamus dapibus gravida facilisis. In hac habitasse platea dictumst. Aliquam tincidunt ultricies enim sed pellentesque. In in mi in libero laoreet ultricies. Phasellus non metus dolor parturient vitae neque venenatis. </p>
						<p class="text-right"><a href="#about" class="button background-75-f heading-f border-heading-d">About Us</a><a href="#work" class="button background-75-c heading-c border-heading-c">Our Work</a></p>
					</div>
				</div>
			</div>
		</div>
...
<section id="about">
	<div class="view"> <img alt class="bg" src="<?php echo base_url() ?>Theme/theme-viki/images/placeholders/1920x1200-2.jpg" />
				...
				<div class="row hidden-xs hidden-sm">
					<div class="col-md-4 colors-b">
						<div class="row">
							...
							<div class="col-xs-12 success heading-b banner-cell"> Responsive Styling <br />
								Retina Ready </div>
						</div>
					</div>
					<div class="col-md-4 colors-c">
						<div class="row">
							...
							<div class="col-xs-12 warning heading-c banner-cell"> Highly Optimized <br />
								Smooth Animations </div>
						</div>
					</div>
					<div class="col-md-4 colors-d">
						<div class="row">
							...
							<div class="col-xs-12 info heading-d banner-cell"> Adapted for Multicolor Sections <br />
								Highly Customized </div>
						</div>
					</div>
				</div>
			</div>
	...
	<div class="view"> <img alt class="bg" src="<?php echo base_url() ?>Theme/theme-viki/images/placeholders/1920x1200-0.jpg" /><img alt class="bg" src="<?php echo base_url() ?>Theme/theme-viki/images/placeholders/1920x1200-1.jpg" />
		<div class="content colors-e">
			<div class="container">
				...
				<div class="row">
					<div class="col-md-4">
						<div class="col-icon"> <i class="li_bulb"></i> </div>
					...
					<div class="col-md-4">
						<div class="col-icon"> <i class="li_t-shirt"></i> </div>
						<div class="col-content">
					...
					<div class="col-md-4">
						<div class="col-icon"> <i class="li_megaphone"></i> </div>
						<div class="col-content">
	...
	<div class="view" id="how-we-work"> <img alt class="bg" src="<?php echo base_url() ?>Theme/theme-viki/images/placeholders/1920x1200-2.jpg" /><img alt class="bg" src="<?php echo base_url() ?>Theme/theme-viki/images/placeholders/1920x1200-0.jpg" />
			...
			<div class="container">
				...
				<div class="row icon-set">
					<div class="col-md-3 text-center">
						<p> <i class="li_eye circle scroll-in-animation background-20 heading" data-animation="fadeInUp"></i> </p>
						<p class="title"><span class="underline-text">Awesome</span></p>
						<p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
					</div>
					<div class="col-md-3 text-center">
						<p> <i class="li_like circle scroll-in-animation background-20 heading" data-animation="fadeInUp"></i> </p>
						<p class="title"><span class="underline-text">Innovative</span></p>
						<p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
					</div>
					<div class="col-md-3 text-center">
						<p> <i class="li_paperplane circle scroll-in-animation background-20 heading" data-animation="fadeInUp"></i> </p>
						<p class="title"><span class="underline-text">Creative</span></p>
						<p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
					</div>
					<div class="col-md-3 text-center">
						<p> <i class="li_lab circle scroll-in-animation background-20 heading" data-animation="fadeInUp"></i> </p>
...
<section id="team">
	<div class="view"> <img alt class="bg" src="<?php echo base_url() ?>Theme/theme-viki/images/placeholders/1920x1200-1.jpg" /><img alt class="bg" src="<?php echo base_url() ?>Theme/theme-viki/images/placeholders/1920x1200-2.jpg" />
		<div class="content colors-e">
			<div class="container">
				<h2>Team</h2>
				...
				<div class="row">
					<div class="col-md-3 col-sm-6  col-xs-6">
						<div class="hover-overlay"> <img alt="Mike Johnson" src="<?php echo base_url() ?>Theme/theme-viki/images/placeholders/380x573-1.jpg" title="Mike Johnson" class="fluid-width">
							<div class="overlay background-90-b">
								<div>
									<p class="text-center text-uppercase heading-b"> Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. </p>
									<div class="separator-small"></div>
									<p class="text-center"> <a target="_blank" href="https://www.facebook.com/"><i class="fa fa-facebook heading-b"></i></a> <a target="_blank" href="http://www.youtube.com/"><i class="fa fa-youtube heading-b"></i></a> <a target="_blank" href="https://github.com/"><i class="fa fa-github heading-b"></i></a> </p>
								</div>
							</div>
						</div>
						<div class="caption">
							<p> <span class="title">Mike Johnson</span> <br/>
								<span class="highlight">CEO &amp; Founder</span> </p>
						</div>
					</div>
					<div class="col-md-3 col-sm-6  col-xs-6">
						<div class="hover-overlay"> <img alt="Jessica Specter" src="<?php echo base_url() ?>Theme/theme-viki/images/placeholders/380x573-1.jpg" title="Jessica Specter" class="fluid-width">
							<div class="overlay background-90-b">
								<div>
									<p class="text-center text-uppercase heading-b"> Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. </p>
									<div class="separator-small"></div>
									<p class="text-center"> <a target="_blank" href="https://twitter.com/"><i class="fa fa-twitter heading-b"></i></a> <a target="_blank" href="https://www.linkedin.com/"><i class="fa fa-linkedin heading-b"></i></a> <a target="_blank" href="https://plus.google.com/"><i class="fa fa-google-plus heading-b"></i></a> <a target="_blank" href="https://vimeo.com/"><i class="fa fa-vimeo-square heading-b"></i></a> <a target="_blank" href="https://www.tumblr.com/"><i class="fa fa-tumblr heading-b"></i></a> </p>
								</div>
							</div>
						</div>
						<div class="caption">
							<p> <span class="title">Jessica Specter</span> <br/>
								<span class="highlight">Creative Director</span> </p>
						</div>
					</div>
					<div class="col-md-3 col-sm-6  col-xs-6">
						<div class="hover-overlay"> <img alt="Lynda Smith" src="<?php echo base_url() ?>Theme/theme-viki/images/placeholders/380x573-1.jpg" title="Lynda Smith" class="fluid-width">
							<div class="overlay background-90-b">
								<div>
									<p class="text-center text-uppercase heading-b"> Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. </p>
									<div class="separator-small"></div>
									<p class="text-center"> <a target="_blank" href="https://www.flickr.com/"><i class="fa fa-flickr heading-b"></i></a> <a target="_blank" href="https://www.dropbox.com/"><i class="fa fa-dropbox heading-b"></i></a> <a target="_blank" href="https://www.xing.com/"><i class="fa fa-xing heading-b"></i></a> <a target="_blank" href="http://vk.com/"><i class="fa fa-vk heading-b"></i></a> </p>
								</div>
							</div>
						</div>
						<div class="caption">
							<p> <span class="title">Andrew Miles</span> <br/>
								<span class="highlight">Developer</span> </p>
						</div>
					</div>
					<div class="col-md-3 col-sm-6  col-xs-6">
						<div class="hover-overlay"> <img alt="Lynda Smith" src="<?php echo base_url() ?>Theme/theme-viki/images/placeholders/380x573-1.jpg" title="Lynda Smith" class="fluid-width">
							<div class="overlay background-90-b">
								<div>
									<p class="text-center text-uppercase heading-b"> Exercitation ut enim ad minim veniam, quis nostrud ullamco laboris nisi ut aliquip ex ea commodo consequat. </p>
									<div class="separator-small"></div>
									<p class="text-center"> <a target="_blank" href="https://twitter.com/"><i class="fa fa-twitter heading-b"></i></a> <a target="_blank" href="https://www.linkedin.com/"><i class="fa fa-linkedin heading-b"></i></a> <a target="_blank" href="https://plus.google.com/"><i class="fa fa-google-plus heading-b"></i></a> <a target="_blank" href="https://vimeo.com/"><i class="fa fa-vimeo-square heading-b"></i></a> <a target="_blank" href="https://www.tumblr.com/"><i class="fa fa-tumblr heading-b"></i></a> </p>
								</div>
							</div>
						...
						<div class="caption">
							<p> <span class="title">Lynda Smith</span> <br/>
								<span class="highlight">Programmer</span> </p>
						</div>
					</div>
				</div>
				<h3><span class="highlight">We want to change</span><br/>
					peoples lives</h3>
				<div class="row">
					<div class="col-md-6 col-md-offset-3">
						<p class="text-center">Aliquam fermentum massa ac est sollicitudin, at ultricies ligula tristique. Cras finibus, nulla ac convallis feugiat, nisl nisl lobortis est, eget auctor velit magna vel nunc. Donec nec eros rhoncus.</p>
			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-6 stretch-height pane">
						<div class="view fluid-height"> <img alt class="bg" src="<?php echo base_url() ?>Theme/theme-viki/images/placeholders/1920x1200-2.jpg" />
							<div class="content incut colors-d background-transparent">
								<div class="position-middle-center text-center"> <a class="button background-lite-c heading-c" href="#work">View Our Work</a> </div>
							</div>
						</div>
					</div>
					<div class="col-md-6  stretch-height pane">
...
<section id="services">
	...
	<div class="view"> <img alt class="bg" src="<?php echo base_url() ?>Theme/theme-viki/images/placeholders/1920x1200-2.jpg" /><img alt class="bg" src="<?php echo base_url() ?>Theme/theme-viki/images/placeholders/1920x1200-0.jpg" /><img alt class="bg" src="<?php echo base_url() ?>Theme/theme-viki/images/placeholders/1920x1200-1.jpg" />
		<div class="content half-size colors-h">
			<div class="container">
				...
				<p class="text-center big-font"> <em>— Lorem ipsum dolor sit amet —</em> </p>
			</div>
		</div>
	</div>
</section>
<section id="work">
	<div class="view"> <img alt class="bg" src="<?php echo base_url() ?>Theme/theme-viki/images/placeholders/1920x1200-2.jpg" /><img alt class="bg" src="<?php echo base_url() ?>Theme/theme-viki/images/placeholders/1920x1200-0.jpg" />
				...
				<div class="container-fluid">
					<div class="filter">
						<ul class="nav nav-pills text-center">
							...
							<li><a class="hover-effect" data-group="<?= $style->name ?>" href="#">
								<?= $style->name ?>
								</a></li>
							<? endforeach; endif ?>
					...
					<div class="row">
						<div class="grid">
							...
							<div class="item col-md-3 col-sm-4 col-xs-6" data-groups='["<?php echo $row->style_name ?>"]'> 
							<a href="#!<?= site_url() . 'tt_v1/product/' . $row->activity_id ?>" class="hover-overlay"> <img alt="Project <?= $i ?>" src="<?php echo $picture ?>"  />
								<div class="overlay background-90-e">
									<div class="hidden-xs">
										<p class="title heading-e">
											<?= $row->name ?>
										</p>
										<p class="text-center heading-e"><strong>$
											<?= $row->rate_price_price ?>
											</strong></p>
										<p class="text-center"><i class="fa heading-e"></i></p>
									</div>
								</div>
							</a>
								<p class="title heading-e">
...
<section id="process">
	...
	<div class="view" id="numbers"> <img alt class="bg" src="<?php echo base_url() ?>Theme/theme-viki/images/placeholders/1920x1200-0.jpg" /><img alt class="bg" src="<?php echo base_url() ?>Theme/theme-viki/images/placeholders/1920x1200-1.jpg" />
		<div class="content half-size colors-h">
			<div class="container-fluid">
					...
					<div class="col-md-6">
						<div class="skillbars">
							...
							<div class="skillbar clearfix background-d" data-percent="90%">
								<div class="skillbar-title background-20-e heading-c"><span>Wordpress</span></div>
								<div class="skillbar-bar background-20-e"></div>
								<div class="skill-bar-percent heading-d">90%</div>
							</div>
							<div class="skillbar clearfix background-d" data-percent="75%">
								<div class="skillbar-title background-20-e heading-c"><span>SEO</span></div>
								<div class="skillbar-bar background-70-c"></div>
								<div class="skill-bar-percent heading-d">75%</div>
							</div>
							<div class="skillbar clearfix background-d" data-percent="70%">
								<div class="skillbar-title background-20-e heading-c"><span>Photoshop</span></div>
								<div class="skillbar-bar background-20-e"></div>
...
<section id="contact">
	<div class="view"> <img alt class="bg" src="<?php echo base_url() ?>Theme/theme-viki/images/placeholders/1920x1200-1.jpg" /><img alt class="bg" src="<?php echo base_url() ?>Theme/theme-viki/images/placeholders/1920x1200-2.jpg" /><img alt class="bg" src="<?php echo base_url() ?>Theme/theme-viki/images/placeholders/1920x1200-0.jpg" />
		<div class="content full-size colors-h">
			<div class="container">
				...
				<div class="row">
					<div class="col-md-6">
						<div class="text-right scroll-in-animation" data-animation="fadeInLeft">
							<p class="big-font uppercase"> Tel: <strong class="highlight">+7 (781) 503-1810</strong> </p>
							<p class="big-font uppercase"> 500 Unicorn Park Dr, 21st Floor <br/>
								Woburn, MA 01801, United States </p>
							<p class="big-font"> <b> <a href="mailto:info@ouraddress.com">info@ouraddress.com</a><br/>
								<a href="http://www.ouraddress.com">www.ouraddress.com</a> </b> </p>
							<p class="big-font"> <a target="_blank" href="https://twitter.com/"><span class="fa-stack"><i class="fa fa-circle fa-stack-2x heading"></i><i class="fa fa-twitter fa-stack-1x text-background"></i></span></a> <a target="_blank" href="https://www.facebook.com/"><span class="fa-stack"><i class="fa fa-circle fa-stack-2x heading"></i><i class="fa fa-facebook fa-stack-1x text-background"></i></span></a> <a target="_blank" href="http://www.youtube.com/"><span class="fa-stack"><i class="fa fa-circle fa-stack-2x heading"></i><i class="fa fa-youtube fa-stack-1x text-background"></i></span></a> </p>
						</div>
					</div>
					<div class="col-md-6">
						<div class="text-left scroll-in-animation" data-animation="fadeInRight">
							<form class="ajax-form" data-message-class="colors-d background-95 heading border" action="<?php echo base_url() ?>Theme/theme-viki/contact.php" method="post" novalidate>
								<div class="row">
				...
				<div class="text-center"> <a class="map-open button background-lite-b border-heading-b heading-b" data-map-overlay=".map-overlay" href="#">Locate Us on Map</a> </div>
			</div>
		</div>
	</div>
</section>
	...
	<div class="container scroll-in-animation" data-animation="fadeInDown">
		<div class="row">
			...
			<div class="col-md-3">
				<h5>Recent Posts</h5>
				<ul class="simple">
					<li><a href="<?php echo base_url() ?>Theme/theme-viki/blog-single-1.html">Post with Featured Image</a></li>
					<li><a href="<?php echo base_url() ?>Theme/theme-viki/blog-single-2.html">And Post with Slider</a></li>
					<li><a href="<?php echo base_url() ?>Theme/theme-viki/blog-single-3.html">Post with Vimeo Video</a></li>
					<li><a href="<?php echo base_url() ?>Theme/theme-viki/blog-single-4.html">Another Post with Image</a></li>
					<li><a href="<?php echo base_url() ?>Theme/theme-viki/blog.html">More...</a></li>
				</ul>
			</div>
			<div class="col-md-3">
				<h5>Photo Stream</h5>
				<div class="photo">
					<div class="col-xs-3 col-sm-2 col-md-4"> <a target="_blank" href="https://www.flickr.com/photos/we-are-envato/12333983853" title="Melbourne Meetup by Envato, on Flickr"><img class="fluid-width" src="<?php echo base_url() ?>Theme/theme-viki/images/placeholders/150x150-1.jpg" alt="Melbourne Meetup"></a> </div>
					<div class="col-xs-3 col-sm-2 col-md-4"> <a target="_blank" href="https://www.flickr.com/photos/we-are-envato/13090549273" title="Around the Envato Office - Highfive! by Envato, on Flickr"><img class="fluid-width" src="<?php echo base_url() ?>Theme/theme-viki/images/placeholders/150x150-2.jpg" alt="Around the Envato Office - Highfive!"></a> </div>
					<div class="col-xs-3 col-sm-2 col-md-4"> <a target="_blank" href="https://www.flickr.com/photos/we-are-envato/12333834195" title="Melbourne Meetup by Envato, on Flickr"><img class="fluid-width" src="<?php echo base_url() ?>Theme/theme-viki/images/placeholders/150x150-1.jpg" alt="Melbourne Meetup"></a> </div>
					<div class="col-xs-3 col-sm-2 col-md-4"> <a target="_blank" href="https://www.flickr.com/photos/we-are-envato/13090422515" title="Around the Envato Office - Becca by Envato, on Flickr"><img class="fluid-width" src="<?php echo base_url() ?>Theme/theme-viki/images/placeholders/150x150-2.jpg" alt="Around the Envato Office - Becca"></a> </div>
					<div class="col-xs-3 col-sm-2 col-md-4"> <a target="_blank" href="https://www.flickr.com/photos/we-are-envato/13090762874" title="Around the Envato Office - Ben &amp; Jane by Envato, on Flickr"><img class="fluid-width" src="<?php echo base_url() ?>Theme/theme-viki/images/placeholders/150x150-1.jpg" alt="Around the Envato Office - Ben &amp; Jane"></a> </div>
					<div class="col-xs-3 col-sm-2 col-md-4"> <a target="_blank" href="https://www.flickr.com/photos/we-are-envato/13090456565" title="Around the Envato Office - Selina by Envato, on Flickr"><img class="fluid-width" src="<?php echo base_url() ?>Theme/theme-viki/images/placeholders/150x150-2.jpg" alt="Around the Envato Office - Selina"></a> </div>
				</div>
			</div>
		</div>
	</div>
	<div class="bottom text-center background-10-b"> © 2015 All Rights Reserved. <a href="#" class="open-overlay-window heading" data-overlay-window=".credits-overlay">Credits.</a> </div>
</footer>
<!-- END: Footer --> 
<script src="<?php echo base_url() ?>Theme/theme-viki/bower_components/less.js/dist/less.min.js"></script> 
<script src="<?php echo base_url() ?>Theme/theme-viki/bower_components/jquery/dist/jquery.min.js"></script> 
<script src="<?php echo base_url() ?>Theme/theme-viki/lib/tween/tween.min.js"></script> 
<script src="<?php echo base_url() ?>Theme/theme-viki/bootstrap/dist/js/bootstrap.min.js"></script> 
<script src="<?php echo base_url() ?>Theme/theme-viki/bower_components/modernizr/modernizr.js"></script> 
<script src="<?php echo base_url() ?>Theme/theme-viki/lib/SmoothScroll-1.2.1/SmoothScroll.js"></script> 
<script src="<?php echo base_url() ?>Theme/theme-viki/bower_components/jquery-cookie/jquery.cookie.js"></script> 
<script src="https://maps.googleapis.com/maps/api/js?sensor=false"></script> 
<script src="<?php echo base_url() ?>Theme/theme-viki/bower_components/jqBootstrapValidation/dist/jqBootstrapValidation-1.3.7.min.js"></script> 
<script src="<?php echo base_url() ?>Theme/theme-viki/bower_components/minicolors/jquery.minicolors.min.js"></script> 
<script src="<?php echo base_url() ?>Theme/theme-viki/bower_components/slick.js/slick/slick.min.js"></script> 
<script src="<?php echo base_url() ?>Theme/theme-viki/bower_components/shufflejs/dist/jquery.shuffle.min.js"></script> 
<script src="<?php echo base_url() ?>Theme/theme-viki/bower_components/textillate/assets/jquery.lettering.js"></script> 
<script src="<?php echo base_url() ?>Theme/theme-viki/bower_components/textillate/assets/jquery.fittext.js"></script> 
<script src="<?php echo base_url() ?>Theme/theme-viki/bower_components/textillate/jquery.textillate.js"></script> 
<script src="<?php echo base_url() ?>Theme/theme-viki/lib/prism/prism.js"></script> 
<script>
		if (typeof(atob) == "undefined")
		{
			document.write('<script src="<?php echo base_url() ?>Theme/theme-viki/lib/stringencoders-v3.10.3/javascript/base64.js"><\/script>');
			var atob = function(x)
			{
...
<script src="<?php echo base_url() ?>Theme/theme-viki/scripts/script-bundle.js"></script> 
<script>
