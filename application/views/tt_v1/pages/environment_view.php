        ...
        <div id="container">
            ...
            <article id="blog-post" class="sg-23">
                ...
                <div id="blog-post-content">
                  <p><!--<a href="<?= site_url() ?>menu_pages/environment#go-top"><img src="<?= base_url(). PAGES_IMAGE_DIR?>logo_vert_standard_color.jpg" alt="one percent for the planet" width="182" height="267" /></a>--></p>
                  <p>&nbsp;</p>
                  <p><a name="go-top" id="top"></a>We are committed to allocating our resources to help preserve the planet. Treks and Tracks is a proud member of the 1% for the planet organization. This means 1% of our gross revenue goes to organizations that help preserve the environment we cherish.</p>
                  <p>Please do your part in preserving the places we  love by simpling following Leave No Trace principles. </p>
                  <h5><br />
                    <span> Treks and Tracks outdoor ethics from the framework of Leave No Trace's message:</span></h5>
                  <ol start="1" type="1">
                  <ul>
                    <li><a href="<?= site_url() ?>menu_pages/environment#planahead">Plan Ahead and Prepare </a></li>
                  </ul>
                  <ul>
                    <li><a href="<?= site_url() ?>menu_pages/environment#travelandcamp">Travel and Camp on Durable Surfaces</a></li>
                  </ul>
                  <ul>
                    <li><a href="<?= site_url() ?>menu_pages/environment#disposeofwaste">Dispose of Waste Properly</a></li>
                  </ul>
                  <ul>
                    <li><a href="<?= site_url() ?>menu_pages/environment#leavewhatyoufind">Leave What You Find</a></li>
                  </ul>
                  <ul>
                    <li><a href="<?= site_url() ?>menu_pages/environment#minimizecampfire">Minimize Campfire Impact</a></li>
                  </ul>
                  <ul>
                    <li><a href="<?= site_url() ?>menu_pages/environment#respectwildlife">Respect Wildlife</a></li>
                  </ul>
                  <ul>
                    <li><a href="<?= site_url() ?>menu_pages/environment#beconsiderate">Be Considerate of Other Visitors</a></li>
                  </ul>
                  <p>&nbsp;</p>
                  <p>&nbsp;</p>
                  <h4><a name="planahead" id="planahead"></a>Plan Ahead and Prepare</h4>
                  <ul type="disc">
                    ...
                    <p><a class="go-top" href="<?= site_url() ?>menu_pages/environment#go-top">Go top</a></p>
                  </ul>
                  <h4><a name="travelandcamp" id="travelandcamp"></a>Travel and Camp on Durable Surfaces</h4>
                  <ul type="disc">
                  ...
                  <h4><a name="disposeofwaste" id="disposeofwaste"></a>Dispose of Waste Properly</h4>
                  <ul type="disc">
                  ...
                  <h4><a name="leavewhatyoufind" id="leavewhatyoufind"></a>Leave What You Find</h4>
                  <ul type="disc">
                  ...
                  <h4><a name="minimizecampfire" id="minimizecampfire"></a>Minimize Campfire Impacts</h4>
                  <ul type="disc">
                  ...
                  <h4><a name="respectwildlife" id="respectwildlife"></a>Respect Wildlife</h4>
                  <ul type="disc">
                  ...
                  <h4><a name="beconsiderate" id="beconsiderate"></a>Be Considerate of Other Visitors</h4>
                  <ul type="disc">
                  ...
                  <h4><strong>&nbsp;</strong></h4>
<p><!--<a href="<?= site_url() ?>menu_pages/environment#go-top"><img src="<?= base_url(). PAGES_IMAGE_DIR?>logo_vert_standard_color.jpg" alt="one percent for the planet" width="182" height="267" align="left" /></a>--><img src="<?= base_url(). PAGES_IMAGE_DIR?>amga_spi.jpg" alt="AMGA certified guides" width="200" height="256" align="right" /></p>
                    <p></p>
                </div>
