...
<div id="container"> 
		...
		<div id="blog-post-content<?=$i++ ?>" >
				<? if (  $row->picture) :  ?>
				<img class="guides_large" src="<?= base_url(). PAGES_IMAGE_DIR?><?= $row->picture ?>"  alt="Guide Picure" align="left">
				<? endif ?>
				...
				<p>
						<?= $row->bio ?>
						<? if (  $row->is_amga) :  ?>
						<img src="<?= base_url(). PAGES_IMAGE_DIR?>amga_spi.jpg" alt="AMGA certified guides" width="133" height="170" align="right" />
						<? endif ?>
				</p>
				<div class="line"></div>
				<p>&nbsp;</p>
