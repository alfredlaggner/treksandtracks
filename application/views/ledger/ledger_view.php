		...
		<div id="page-content-wrapper">
			<div class="inner-page-title">
				...
				<span>On <b><?php echo date('M-d-y',strtotime($row->date)); ?></b> from  <b><?php echo date('G:i',strtotime($row->time)); ?> </b> to 
								<b><?php echo date('G:i',strtotime($row->time)+$row->duration*3600); ?></b></span> </div>
			<p>					
			...
			<div id="inputform">
				<ul>
					...
					<input type="hidden"  name="from_calendar" id="from_calendar" value='<?php echo $row->from_calendar ?>' />
					...
					<input type="hidden" name="duration" id="duration"  class="text" readonly  value='<?php  echo $row->duration ?>'  />
					<input type="hidden" name="instructor" id="instructor"  class="text" readonly  value='<?php echo $row->instructor ?>'  />
					<input type="hidden" name="price" id="price"  class="text" readonly  value='<?php  echo $row->price ?>'  />
					<input type="hidden" name="discount" id="discount"  class="text" readonly  value='<?php echo $row->discount ?>'  />
					...
					<input type="hidden" name="promo_code" id="promo_code"  class="text"  value='<?php  echo $row->promo_code ?>'  />
					<input type="hidden" name="attending" id="attending"  class="text"  value='<?php  echo $row->attending ?>'  />
<!--						<td>
...
-->					<?php echo form_close(); ?>
		...
		<div class="hastable">
					...
					<input type="submit" name="return" value="Add Customer" class="ui-state-default float-right ui-corner-all ui-button" />
