...
On <b><?php echo date('M-d-y',strtotime($event['event_date'])); ?></b> from  <b><?php echo date('G:i',strtotime($event['event_time'])); ?> </b> to 
			...
			<p>					
				Instructors: <b><?php echo '' //urldecode($event['instructor']) ?> </b>&nbsp;
				...
				<table id="sort-table">
					...
					<tbody>
						...
						<tr>
							...
							<td><a class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="Edit ledger" href="<?php echo site_url().'ledger/ledger_view/' ?><?php echo $row->ledger_ledger_id; ?>"> <span class="ui-icon ui-icon-wrench"></span> </a> <a class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="Edit attendants" href="<?php echo site_url().'ledger/attendants/' ?><?php echo $row->ledger_ledger_id; ?>/<?php echo $row->attending; ?>"> <span class="ui-icon ui-icon-contact"></span> </a> <a class="btn_no_text btn ui-state-default ui-corner-all tooltip confirmClick" title="Delete ledger" href="<?php echo site_url().'ledger/delete/' ?><?php echo $row->ledger_ledger_id; ?>"> <span class="ui-icon ui-icon-trash"></span> </a></td>
						</tr>
						<?php endforeach; endif; ?>
					</tbody>
				</table>
