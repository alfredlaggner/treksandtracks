		...
		<div id="page-content-wrapper">
			...
			<div id="inputform">
				<ul>
					...
					<input type="hidden" name="booking_date" id="booking_date" value= '<?php echo date("Y-m-d H:i:s") ?>' />
					
					<input type="hidden" name="from_calendar" id="from_calendar" value= '<?php echo $from_calendar ?>' />
					<li>
						<label>Activity</label>
						<input type="text"  name="name" id="name"  class="text"  readonly="readonly" value='<?php echo urldecode($records['name']); ?>'  />
					</li>
					<li>
						<label>Date</label>
						<input type="text" name="date" id="date"  class="text" readonly  value='<?php echo $records['date']; ?>'  />
					</li>
					<li>
						<label>Time</label>
						<input type="text" name="time" id="time"  class="text" readonly  value='<?php echo $records['time']; ?>'  />
					</li>
					<li>
						<label>Duration</label>
						<input type="text" name="duration" id="duration"  class="text" readonly  value='<?php echo $records['duration']; ?>'  />
						(Hours) </li>
					<li>
						<label>Instructors</label>
						<input type="text" name="instructor" id="instructor"  class="text" readonly  value='<?php echo urldecode($records['instructor']); ?>'  />
					</li>
					<li>
						<label>Rate</label>
						<input type="text" name="price" id="price"  class="text" readonly  value='<?php echo $records['price']; ?>'  />
					</li>
					<li>
						<label>Discount</label>
						<input type="text" name="discount" id="discount"  class="text" readonly  value='<?php echo $records['discount']; ?>'  />
					</li>
					<li>
						<label>Tax</label>
						<input type="text" name="tax" id="tax"  class="text" readonly  value='<?php echo $records['tax']; ?>'  />
					</li>
					<li>
						<label>Max Participants</label>
						<input type="text" name="capacity" id="capacity"  class="text" readonly  value='<?php echo $records['capacity']; ?>' />
					</li>
					<li>
						<label>Available</label>
						<input type="text" name="available" id="available"  class="text" readonly  value='<?php echo $records['available']; ?>' />
					</li>
					<li> 
...
var ValidTF1 = new Spry.Widget.ValidationTextField("int_attending", "integer", {minValue:1, maxValue:20, useCharacterMasking:false, validateOn:["blur", "change"]});
