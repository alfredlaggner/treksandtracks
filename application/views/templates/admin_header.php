        <!-- header -->
            <header>
                <div class="container">
                    <div class="row">
                        <div class="span3">
                            <div class="main-logo"><a href="dashboard.html"><img src="<?= base_url() ?>img/beoro_logo.png" alt="Beoro Admin"></a></div>
                        </div>
                        <div class="span5">
                            <nav class="nav-icons">
                                <ul>
                        ...
                        <div class="span4">
                            <div class="user-box">
                                <div class="user-box-inner">
                                    <img src="<?= base_url() ?>img/avatars/avatar.png" alt="" class="user-avatar img-avatar">
                                    <div class="user-info">
                                    </div>
                                </div>
                            </div>
