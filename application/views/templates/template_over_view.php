...
<script type="text/javascript" src="<?php echo base_url() ?>tablesorter/addons/pager/jquery.tablesorter.pager.min.js"></script>
...
-->
		...
		<input type="hidden" class="invisible-table-row" value="<?= $row->template_id?>" name="template_id" />
					<tr>
					...
					<td>
					<? $is_choose = $this->session->is_choose;
					if ($is_choose == '1')  : ?>
						<a class="btn_no_text btn ui-state-default ui-corner-all tooltip  confirmClick" title="Send mails now without changes!" href="<?php echo site_url().'customer_contact/send_mail/'?><?= $row->template_id. '/' . TRUE . '/' . $activity_id ?>"> <span class="ui-icon ui-icon-mail-closed"></span> </a> <a class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="Send mails after editing" href="<?php echo site_url().'customer_contact/template_edit/'?><?= $row->template_id . '/' . TRUE . '/' . $activity_id ?>"> <span class="ui-icon ui-icon-newwin"></span> </a>
						<a class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="Manage attachments" href="<?php echo site_url().'attachment/index/'?><?= $row->template_id . '/' . $activity_id ?>"> <span class="ui-icon ui-icon-plusthick"></span> </a>
						<? else : ?>
						<a class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="Edit eMail" href="<?php echo site_url().'template/template_view/'?><?= $row->template_id?>"> <span class="ui-icon ui-icon-wrench"></span> </a>
						<a class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="Manage attachments" href="<?php echo site_url().'attachment/index/'?><?= $row->template_id . '/' . $activity_id ?>"> <span class="ui-icon ui-icon-plusthick"></span> </a>
						
<a class="btn_no_text btn ui-state-default ui-corner-all tooltip confirmClick" title="Delete eMail" href="<?php echo site_url().'template/delete/'?><?= $row->template_id?>"> <span class="ui-icon ui-icon-trash"></span> </a>						
			...
			<? if ($is_from_manage_templates) : ?>
				<tr>
					<td><input type="submit" name="submit" value="Return to select another activity"   class="buttons" /></td>
				</tr>
