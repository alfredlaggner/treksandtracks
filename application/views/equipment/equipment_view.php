...
<div id="sub-nav">
		<div class="page-title">
				...
				<span><a href="#" title="Home">Home</a> > <a href="#" title="Dashboard">Dashboard</a> > <?php echo anchor('equipment', 'equipment'); ?> > <?php echo $title_action ?></span> </div>
						...
						<div id="inputform">
								...
								<ul>
										<?php echo form_open('equipment/update/'. $row->equipment_id);?>
												...
												<ul><input type="text" name="name" id="name" class="text"  value='<?php echo $row->name; ?>'/></ul>
										
										
												<ul><textarea class="text_area" name="equipment" id="equipment"> <?php echo $row->equipment; ?></textarea></ul>
