...
--> <!-- Create the HTML form containing necessary SIM post values -->
			...
			<input type='hidden' name='x_phone' value='<?= $x_phone; ?>' />-->
									...
									<INPUT TYPE='hidden' NAME="x_relay_url" VALUE="<?= site_url() ?>tt_v3/relay_response">
										...
										<div class="col-md-6">
											...
											<div class="form-group">
												...
												<input type='text' placeholder="Last Name"
												       ...
												       value='<?= $x_last_name; ?>' data-bv-notempty
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type='text' placeholder="Address"
												       ...
												       value='<?= $x_address; ?>' data-bv-notempty
												       data-bv-notempty-message="The address is required"/>
												<div class="help-block with-errors"></div>
											</div>
										</div>
									</div>
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type='text' placeholder="City"
												       ...
												       value='<?= $x_city; ?>' data-bv-notempty
												       data-bv-notempty-message="The city is required"/>
												<div class="help-block with-errors"></div>
											</div>
										</div>
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type='text' placeholder="Zip"
												       ...
												       value='<?= $x_zip; ?>' data-bv-notempty
												       data-bv-notempty-message="The zip code is required"/>
												<div class="help-block with-errors"></div>
											</div>
										</div>
									</div>
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type='text' placeholder="State"
												       ...
												       value='<?= $x_state; ?>' data-bv-notempty
												       data-bv-notempty-message="The state is required"/>
												<div class="help-block with-errors"></div>
											</div>
										</div>
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type='text' placeholder="Country"
												       ...
												       value='<?= $x_country; ?>' data-bv-notempty
												       data-bv-notempty-message="The country is required"/>
												<div class="help-block with-errors"></div>
											</div>
										</div>
									</div>
...
<!--									6011000000000012-->
									<h4 class="sub-title" style="color:green">
										Card Information <span><img class="ximg-fluid" src="<?= site_url() ?>images/visa_mastercard.png" alt="Only Visa or Mastercard" width="100px"></span></h4>
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type='text' placeholder="Credit Card Number"
												       ...
												       value='' data-bv-notempty
												       data-bv-notempty-message="The credit card is required"/>
												<div class="help-block with-errors"></div>
											</div>
										</div>
									</div>
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type='text' placeholder="CCV"
												       ...
												       name='x_card_code'
												       value=''
												       data-bv-cvv-x_card_num data-bv-cvv-message="Invalid ccv"/>
												<div class="help-block with-errors"></div>
											</div>
										</div>
									</div>
