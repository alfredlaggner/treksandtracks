...
<div class="hidden-md-up">
	<nav class="navbar">
		<ul>
			<li class="nav-item"><a class="nav-link" href=<?= site_url() . "tt_v3" ?>><span>Home</span></a></li>
			<li class="nav-item">
				<a class="nav-link"  href=<?= site_url() . "tt_v3/index/#top" ?>><span>Classes</span></a>
			</li>
			<li class="nav-item"><a class="nav-link" href="<?= site_url() ?>menu_pages_v3/about_us"><span>About Us</span></a>
			</li>
		</ul>
	</nav>
</div>
