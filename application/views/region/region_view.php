...
<div id="sub-nav">
		<div class="page-title">
				...
				<span><a href="#" title="Home">Home</a> > <a href="#" title="Dashboard">Dashboard</a> > <?php echo anchor('region', 'Region'); ?> > <?php echo $title_action ?></span> </div>
				...
				<div id="page-content-wrapper">
						...
						<div id="inputform">
								...
								<table width="800" border="0">
										...
										<tr>
												<td>Code</td>
												<td><input type="text"  name="region" id="region"  class="text" value='<?php echo $row->region ?>'  /></td>
										</tr>
										<tr>
