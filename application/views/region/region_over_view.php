				...
				<form name="myform" class="pager-form" method="post" action="">
					<table id="sort-table">
						...
						<tr>
                            ...
                            <a class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="Edit Region" href="<?php echo site_url().'region/region_view/'?>{region_id}"> <span class="ui-icon ui-icon-wrench"></span> </a>
                                                        
                             <a class="btn_no_text btn ui-state-default ui-corner-all tooltip confirmClick" title="Delete Region" href="<?php echo site_url().'region/delete/'?>{region_id}"> <span class="ui-icon ui-icon-trash"></span> </a></td>
						</tr>
						{/records}
							</tbody>
