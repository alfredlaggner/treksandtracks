...
<div id="sub-nav">
	<div class="page-title">
		...
		<span><a href="#" title="Home">Home</a> > <a href="#" title="Dashboard">Dashboard</a> > <?php echo anchor('account', 'account'); ?> > <?php echo $title_action ?></span> </div>
			...
			<div id="inputform">
				...
				<ul>
					...
					<li>
						...
						<input type="text"  name="account_name" id="account_name"  class="text" value='<?php echo  $row->account_name ?>'  />
					</li>
					<li>
						<label>Short Name</label>
						<input type="text" name="account_short" id="account_short"  class="text"  value='<?php echo  $row->account_short ?>'  />
					</li>
					<li>
						<label>Account Created</label>
						<input type="text" name="created_on" id="created_on"  class="text"  value='<?php echo  $row->created_on ?>'  />
					</li>
					<li>
						<label>Type</label>
					...
					<li>
						...
						<input type="text"  name="first_name" id="first_name"  class="text" value='<?php echo $row->first_name ?>'  />
					</li>
					<li>
						<label>Last Name</label>
						<input type="text" name="last_name" id="last_name"  class="text"  value='<?php echo  $row->last_name ?>'  />
					</li>
					<li>
