...
<div id="sub-nav">
	<div class="page-title">
		...
		<span><a href="#" title="Home">Home</a> > <a href="#" title="Dashboard">Dashboard</a> > <?php echo anchor('employee', 'Employee'); ?> > <?php echo $title_action ?></span> </div>
			...
			<div id="inputform">
				...
				<ul>
					...
					<li>
						...
						<input type="text" name="initials" id="initials"  class="text" maxlength="3"  value='<?php echo $row->initials ?>'  />
					</li>
					<li>
						<label>DOB</label>
					...
					<li>
						...
						<select type="text" name="employee_function_id" id="employee_function_id" class="text"   value='<?php echo $row->employee_function_id; ?>'/>
						...
						<option selected value="<?php echo  $employee_function->employee_function_id; ?>"><?php echo  $employee_function->name; ?></option>
						<?php else : ?>
						<option          value="<?php echo  $employee_function->employee_function_id; ?>"><?php echo  $employee_function->name; ?></option>
						<?php endif; ?>
						<?php endforeach; ?>
						<?php endif; ?>
						</select>
					...
					<li>
						<label>Picture</label>
						<input type="text" name="picture" id="picture"  class="text"  value='<?php echo $row->picture ?>'  />
					</li>
					<li>
						<label>Bio</label>
					...
					<input type="text" class="text" name="subtitle" id="subtitle" value='<?php echo $row->subtitle ?>' />
					</li>
					<li>
					<label>Published Slogan</label>
					<input type="text" class="text" name="slogan" id="slogan" value='<?php echo $row->slogan ?>' />
					</li>
					<li>
					<label>Order</label>
