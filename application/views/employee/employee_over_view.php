				...
				<table id="sort-table">
					...
					<tbody>
						...
						<tr>
							...
							<td><?php $commission= 'kommt bald '; echo $commission .'%'; ?></td>
							
							<td><a class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="Edit employee" href="<?php echo site_url().'employee/employee_view/' ?><?php echo $row->employee_id; ?>"> <span class="ui-icon ui-icon-wrench"></span> </a> 

							<a class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="Employee Commission" href="<?php echo site_url().'employee/employee_cms_overview/' ?><?php echo $row->employee_id; ?>"> <span class="ui-icon ui-icon-wrench"></span> </a> 
							
<a class="btn_no_text btn ui-state-default ui-corner-all tooltip confirmClick" title="Delete employee" href="<?php echo site_url().'employee/delete/' ?><?php echo $row->employee_id ?>"> <span class="ui-icon ui-icon-trash"></span> </a>
