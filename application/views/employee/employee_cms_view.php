			...
			<div id="inputform">
				...
				<ul>
					...
					<li>
						...
						<input type="text"  name="cms_eff_date" id="cms_eff_date"  class="text" value='<?php echo $row->cms_eff_date ?>'  />
					</li>
					<li>
						<label>Rate in %</label>
						<input type="text" name="cms_amount" id="cms_amount"  class="text"  value='<?php echo $row->cms_amount ?>'  />
					</li>
					<li>
						<td>
