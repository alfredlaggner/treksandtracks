				...
				<form name="myform" class="pager-form" method="post" action="">
					<table id="sort-table">
						...
						<tr>
                            ...
                            <a class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="Edit Home Slide" href="<?php echo site_url().'home_slider/home_slider_view/'?><?= $row->home_slider_home_slider_id?>"> <span class="ui-icon ui-icon-wrench"></span> </a>
                            
                            
																<a class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="Edit Pictures" href="<?= site_url().'home_slider_pictures/index/0/' ?><?= $row->home_slider_home_slider_id  ?>"> <span class="ui-icon ui-icon-image"></span> </a> 
                            
                            
                             <a class="btn_no_text btn ui-state-default ui-corner-all tooltip confirmClick" title="Delete Home Slide" href="<?php echo site_url().'home_slider/delete/'?><?= $row->home_slider_home_slider_id?>"> <span class="ui-icon ui-icon-trash"></span> </a></td>
						</tr>
				<? endforeach; endif; ?>
							</tbody>
