...
<div id="sub-nav">
	<div class="page-title">
		<h1><?= $title ?></h1>
		<span><a href="#" title="Home">Home</a> > <a href="#" title="Dashboard">Dashboard</a> > <?= anchor('location', 'Home Slide'); ?> > <?= $title_action ?></span> </div>
			...
			<div id="inputform">
				<ul width="800" border="0">
					<?= form_open('home_slider/update/' . $row->home_slider_id ); ?>
                        ...
                        <label>Region</label>
                        <li><select type="text" name="region_id" id="region_id" class="text"  value='<?= $row->region_id; ?>'  />
						...
						<li><textarea class="text_area" name="description_short" id="description_short" rows="3" cols="30"><?= $row->description_short; ?> </textarea></li>
