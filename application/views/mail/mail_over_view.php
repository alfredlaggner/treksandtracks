				...
				<form name="myform" class="pager-form" method="post" action="">
					<table id="sort-table">
						...
						<tr>
                            ...
                            <a class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="Edit Mail" href="<?php echo site_url().'mail/mail_view/'?><?php echo $row->mail_id; ?>"> <span class="ui-icon ui-icon-wrench"></span> </a>
                            
                            
                             <a class="btn_no_text btn ui-state-default ui-corner-all tooltip confirmClick" title="Delete Mail" href="<?php echo site_url().'mail/delete/'?><?php echo $row->mail_id; ?>"> <span class="ui-icon ui-icon-trash"></span> </a></td>
						</tr>
