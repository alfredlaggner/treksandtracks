                ...
                <input type="submit" name="check_dates" value="Select Dates"  class="buttons" />
					<table id="sort-table">
						...
						<tr>
                            ...
                            <a class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="View Mail" href="<?php echo site_url().'mail_sent/mail_sent_view/'?><?php echo $row->mail_id; ?>"> <span class="ui-icon ui-icon-wrench"></span> </a>
                            
                            
                             <a class="btn_no_text btn ui-state-default ui-corner-all tooltip confirmClick" title="Delete Mail" href="<?php echo site_url().'mail_sent/delete/'?><?php echo $row->mail_id; ?>"> <span class="ui-icon ui-icon-trash"></span> </a></td>
						</tr>
