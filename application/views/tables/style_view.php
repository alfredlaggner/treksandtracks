			...
			<div class="content-box">
				<div id="inputform">
					<table>
						...
						<?php echo form_open('style/update/'.$row->style_id);?>
						<tr>
							<input type="hidden"  name="" id="style_id"  value='<?php echo $row->style_id; ?>'/>
						</tr>
						<tr>
							<td><input type="text" name="name" id="name"  class="text"  value='<?php echo $row->name; ?>'/><br />
							<td><input type="text" name="order" id="order"  class="text"  value='<?php echo $row->order; ?>'/><br />
								<textarea class="text_area" name="description" id="description" ><?php echo $row->description; ?></textarea></td>
					...
					<hr />
					<h3>Create</h3>
					<?php echo form_open('style/create');?>
					<table>
						<tr>
							<td>Name/Description</td>
							<td></td>
