			...
			<div class="content-box">
				<div id="inputform">
					...
					<?php echo form_open('home_slider_pictures/update/'.$row->home_slider_picture_id);?>
							<input type="hidden"  name="home_slider_picture_id" id="home_slider_picture_id"  value='<?php echo $row->home_slider_picture_id; ?>'/>
							<input type="hidden"  name="home_slider_id" id="home_slider_id"  value='<?php echo $row->home_slider_id; ?>'/>
							<input type="hidden"  name="folder" id="folder"  value='<?php echo $row->folder; ?>'/>
						<tr>
						<td><img src="<?= base_url() . CLASSES_IMAGE_DIR . $row->folder . '/' . $row->picture ?>" width="150" height="150" /></td>
					...
					<table>
						...
						<tr>
							...
							<input type="hidden"  name="home_slider_id" id="home_slider_id"  value='<?php echo $home_slider_id; ?>'/>
