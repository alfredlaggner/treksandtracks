			...
			<div class="content-box">
				<div id="inputform">
					...
					<?php echo form_open('employee_function/update/'.$row->employee_function_id);?>
							<input type="hidden"  name="" id="employee_function_id"  value='<?php echo $row->employee_function_id; ?>'/>
						<li>
						...
						<li>
							...
							<input type="text" name="short" id="short"  class="text"  value='<?php echo $row->short; ?>'/>
						</li>
						<li>
