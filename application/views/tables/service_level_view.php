			...
			<div class="content-box">
				<div id="inputform">
					<table>
						...
						<tr>
							<input type="hidden"  name="" id="service_level_id"  value='<?php echo $row->service_level_id; ?>'/>
							<td><input type="text"  name="level" id="level"    class="text" value='<?php echo $row->level; ?>'/><br />
								<input type="text" name="name" id="name"  class="text"   value='<?php echo $row->name; ?>'/><br />
