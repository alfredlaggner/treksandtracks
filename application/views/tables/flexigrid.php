...
<div id="sub-nav">
	<div class="page-title">
		...
		<span>You can use the breadcrumb as a sub heading if you like ... Below you'll see some tables using the FlexiGrid JQuery Plugin.</span> </div>
	...
	<div id="page-content">
		<div id="page-content-wrapper">
			<div class="inner-page-title">
				<h2>Example 1</h2>
				<span>The most basic example with the zero configuration, with a table converted into flexigrid</span> </div>
			<table class="flexme1">
				<thead>
					<tr>
