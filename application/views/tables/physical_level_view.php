		...
		<div id="page-content-wrapper">
			...
			<div class="content-box">
				<div id="inputform">
					...
					<?php echo form_open('physical_level/update/'.$row->physical_level_id);?>
						<tr>
							<input type="hidden"  name="" id="physical_level_id"  value='<?php echo $row->physical_level_id; ?>'/>
					...
					<hr />
					<h3>Create</h3>
					<?php echo form_open('physical_level/create');?>
					<table>
						<tr>
							<td>Name/Description</td>
							<td></td>
