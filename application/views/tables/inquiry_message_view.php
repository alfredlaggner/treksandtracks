		...
		<div id="page-content-wrapper">
			...
			<div class="content-box">
				<div id="inputform">
					...
					<?php echo form_open('inquiry_message/update/'.$row->inquiry_message_id);?>
						<tr>
							<input type="hidden"  name="" id="inquiry_message_id"  value='<?php echo $row->inquiry_message_id; ?>'/>
							<td><input type="text" name="name" id="name"  class="text"  value='<?php echo $row->name; ?>'/><br /><textarea class="text_area" name="description" id="description" ><?php echo $row->description; ?></textarea></td>
					...
					<hr />
					<h3>Create</h3>
					<?php echo form_open('inquiry_message/create');?>
					<table>
						<tr>
							<td>Name/Message</td>
							<td></td>
