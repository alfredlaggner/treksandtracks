			...
			<div class="content-box">
				<div id="inputform">
					...
					<table>
						...
						<?php echo form_open('confirmation_message/update/'.$row->confirmation_message_id);?>
						<tr>
							<input type="hidden"  name="" id="confirmation_message_id"  value='<?php echo $row->confirmation_message_id; ?>'/>
					...
					<hr />
					<h3>Create</h3>
					<?php echo form_open('confirmation_message/create');?>
					<table>
						<tr>
							<td>Name/Message</td>
							<td></td>
