		...
		<div id="page-content-wrapper">
			...
			<div class="content-box">
				<div id="inputform">
					...
					<?php echo form_open('activity_pictures/update/'.$row->activity_picture_id);?>
							<input type="hidden"  name="activity_picture_id" id="activity_picture_id"  value='<?php echo $row->activity_picture_id; ?>'/>
						...
						<tr>
						<td><img src="<?= base_url() . CLASSES_IMAGE_DIR . strtoupper($row->folder) . '/' . $row->picture ?>" width="150" height="150" /></td>
					...
					<hr />
					<h3>Create</h3>
					<?php echo form_open('activity_pictures/create');?>
					<table>
						<tr>
							<td>Picture</td>
							<td></td>
