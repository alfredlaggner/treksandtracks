...
<?php $this->load->view('modules/header_left_sidebar') ?>
  <script src="http://maps.google.com/maps?file=api&amp;v=2&amp;sensor=false&amp;key=ABQIAAAAr0bshN4cQiVOhgPo6Ypm7RTNsElaGkaOa0i523uXAdE31ey5aRSNPRly0nT7KWMJUpFhEb2m6u6xag" type="text/javascript"></script>
      ...
      <div class="content-box">
        <div id="inputform">
          <ul>
            ...
            <input type="hidden"  name="" id="coordinates_id"  value='<?php echo $row->coordinates_id; ?>'/>
            <input type="hidden"  name="location_id" id="location_id"  value='<?php echo $row->location_id; ?>'/>
            <li>
              <label for="location">Location</label>
              <input type="text" name="location" id="location"  class="text"  value='<?php echo $row->location; ?>'/>
            </li>
            <li>
              <label for="latitude">Latitude</label>
              <input type="text" name="latitude" id="latitude"  class="text"  value='<?php echo $row->latitude; ?>'/>
            </li>
            <li>
              <label for="langitude">Longitude</label>
              <input type="text" name="longitude" id="longitude"  class="text"  value='<?php echo $row->longitude; ?>'/>
            </li>
            <li>
