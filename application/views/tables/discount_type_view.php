			...
			<div class="content-box">
				<div id="inputform">
					...
					<table>
						...
						<tr>
							<input type="hidden"  name="" id="discount_type_id"  value='<?php echo $row->discount_type_id; ?>'/>
							<td><input type="text"  name="type" id="type"    class="text" value='<?php echo $row->type; ?>'/><br />
