			...
			<div class="content-box">
				<div id="inputform">
					...
					<?php echo form_open('coordinates/update/'.$row->coordinates_id);?>
							...
							<li><input type="text" name="location" id="location"  class="text"  value='<?php echo $row->location; ?>'/></li>
							<li><input type="text" name="longitude" id="longitude"  class="text"  value='<?php echo $row->longitude; ?>'/></li>
							<li><input type="text" name="latitude" id="latitude"  class="text"  value='<?php echo $row->latitude; ?>'/></li>
