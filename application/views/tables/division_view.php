				...
				<div id="inputform">
					<table>
						...
						<tr>
							...
							<td><input type="text" class="text" name="name" id="name"  value='<?php echo $row->name; ?>'/><br />
							<textarea class="text_area" name="description" id="description"rows="3" cols="30"><?php echo $row->description; ?></textarea></td>
