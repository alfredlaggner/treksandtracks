			...
			<div class="content-box">
				<div id="inputform">
					...
					<table>
						...
						<tr>
							<input type="hidden"  name="" id="booking_message_id"  value='<?php echo $row->booking_message_id; ?>'/>
							<td><input type="text" name="name" id="name"  class="text"  value='<?php echo $row->name; ?>'/>
							<br />	<textarea class="text_area" name="description" id="description" ><?php echo $row->description; ?></textarea></td>
