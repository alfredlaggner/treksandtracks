			...
			<div id="inputform">
				...
				<ul>
					...
					<li>
						...
						<input type="text" name="activity_name" id="activity_name"  class="text"  value='<?=  $row->activity_name ?>'  />
					<li>
					<li>
						<label>Activity</label>
						<input type="text" name="activity_code" id="activity_code"  class="text"  value='<?=  $row->activity_code ?>'  />
					<li>
					<li>
