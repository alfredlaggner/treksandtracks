				...
				<table id="sort-table">
					...
					<tbody>
						...
						<tr>
							...
							<td><a class="btn_no_text btn ui-state-default ui-corner-all tooltip " title="View History" href="<?php echo site_url().'customer_contact/customer_contact_overview/' ?><?php echo $row->customer_id; ?>/<?php echo str_replace( '@','at', $email); ?>/<?= strpos ($email,'@')==0 ? 0 : strpos ($email,'@')  ?>"> <span class="ui-icon ui-icon-folder-collapsed"></span> </a> 
							
							<a class="btn_no_text btn ui-state-default ui-corner-all tooltip " title="Edit customer info" href="<?php echo site_url().'customer/customer_view/' ?><?php echo $row->customer_id; ?>"> <span class="ui-icon ui-icon-wrench"></span> </a> 
<? if (isset($event_id)) : ?>							
							<a class="btn_no_text btn ui-state-default ui-corner-all tooltip confirmClick " title="Delete Customer" href="<?php echo site_url().'customer_contact/delete/' ?><?php echo $row->customer_id;  ?>/<?php echo $event_id;  ?>/<?php echo $location_id;  ?>/<?php echo $row->status;  ?>" > <span class="ui-icon ui-icon-trash"></span> </a> 
<? endif ?>							
