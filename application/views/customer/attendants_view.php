...
<div id="sub-nav">
	<div class="page-title">
		...
		<span><a href="#" title="Home">Home</a> > <a href="#" title="Dashboard">Dashboard</a> > <?php echo anchor('customer', 'Customer'); ?> > <?php echo $title_action ?></span> </div>
			...
			<div id="inputform">
				...
				<ul>
					...
					<li>
						...
						<input type="text"  name="first_name" id="first_name"  class="text required" value='<?php echo $row->first_name ?>'  />
						<span class="textfieldRequiredMsg">First name is required.</span></span>
					<li>
						<label>Last Name</label>
						<span id="edit_last_name">
						<input type="text" name="last_name" id="last_name"  class="text required"  value='<?php echo  $row->last_name ?>'  />
						<span class="textfieldRequiredMsg">First name is required.</span></span>
					</li>
					<li>
						<label>DOB</label>
						<input type="text" name="date_of_birth" id="date_of_birth"  class="text"  value='<?php echo  $row->date_of_birth ?>'  />
					</li>
					<li>
						<label>Sex</label>
						...
						<input type="text" name="address1" id="address1"  class="text"  value='<?php echo  $row->address1 ?>'  />
					</li>
					<li>
						<label>Address 2</label>
						<input type="text" name="address2" id="address2"  class="text"  value='<?php echo  $row->address2 ?>'  />
					</li>
					<li>
						<label>City</label>
					...
					<li>
					<label>Country</label>
						<input type="text"  name="country" id="country"  class="text"  value='<?php echo  $row->country ?>' />
					</li>
					<li>
					<label>Email</label>
					...
					<label>Physical Condition</label>
						<input type="text"  name="physical_condition_id" id="physical_condition_id"  class="text"  value='<?php echo  $row->physical_condition_id ?>' />
					</li>
					<li>
					<label>Describe your health</label>
						<textarea name="health_self_description" id="health_self_description" class="text_area"><?php echo  $row->health_self_description ?></textarea>
					</li>
					<li>
					<label>Describe your adventure experience</label>
						<textarea name="experience_self_description" id="experience_self_description" class="text_area"><?php echo  $row->experience_self_description ?></textarea>
					</li>
					<li>
				...
				<ul>
					...
					<input type="hidden"  name="main_customer" id="main_customer"  value='<?php  if ($j==1) echo 1; else echo 0; ?>'  />
					<li>
					...
					<li>
					<label>Physical Condition</label>
						<input type="text"  name="physical_condition_id" id="physical_condition_id"  class="text"  value='' />
					</li>
					<li>
					<label>Describe your health</label>
						<textarea name="health_self_description" id="health_self_description" class="text_area"></textarea>
					</li>
					<li>
					<label>Describe your adventure experience</label>
						<textarea name="experience_self_description" id="experience_self_description" class="text_area"></textarea>
					</li>
					<li>
						<td>
...
var add_dob = new Spry.Widget.ValidationTextField("add_dob", "date", {format:"yyyy-mm-dd", hint:"yyyy-mm-dd", useCharacterMasking:true, isRequired:false, minValue:"0000-00-00"});
...
var edit_dob = new Spry.Widget.ValidationTextField("edit_dob", "date", {format:"yyyy-mm-dd", hint:"yyyy-mm-dd", useCharacterMasking:true, isRequired:false, minValue:"0000-00-00"});
</script>
</body></html>