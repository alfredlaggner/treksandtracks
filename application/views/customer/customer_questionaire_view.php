...
#customer_data .accepted { color:#F50D11;
	
	}	 
#customer_data h2 { font-size:18px; padding: 10px 0 10px 0;  
	
}	 
#customer_data h3 { font-size:16px; padding: 10px 0 10px 0;
	
}	
#customer_data h4 { font-size:16px; padding: 10px 0 10px 0;
	
}	
							
 
</style>
<?  $is_questionaire = FALSE; if(isset($questionaires)) : foreach($questionaires as $row) : ?>
<? $is_questionaire = $row->is_questionaire ?>
<? endforeach; endif ?>
<div id="page-layout">
		<div id="page-content">
				<div id="page-content-wrapper">
						...
						<div id="customer_data">
								...
								<?= form_open('tt_v1/update_questionaire/'. $row->customer_id,$attributes);?>
								<li class = "new_line">
								...
								<div id="left">
										...
										<fieldset>
												...
												<label for= "is_questionaire"  id="somelabel" class="<?= $row->is_questionaire ? 'accepted' : '' ?>">Please check if you accept!</label>
										</fieldset>
										<fieldset>
												<li class = "new_line">
				...
				?>
														<label>Gender </label>
														<?= form_dropdown('sex' ,$choices,'',$data) ?>
												</li>
												<li class = "new_line">
														<? $data = ['type' => 'number', 'placeholder' => 'inch',  'min' =>'0', 'max' => '999','class' => 'text']; ?>
														<label>Height</label>
														<?= form_number('height' ,'',$data) ?>
												</li>
												<li class = "new_line">
														<? $data = ['type' => 'number','placeholder' => 'pound',  'min' =>'0', 'max' => '999', 'class' => 'text']; ?>
														<label>Weight</label>
														<?= form_number('weight' ,'',$data) ?>
												</li>
										</fieldset>
										<h4>Please describe your level of physical conditioning</h4>
										<fieldset>
												<legend>Include what types of exercise you do and how often you do each activity.</legend>
												<? $data = ['id' =>'mytextarea']; ?>
												<?= form_textarea5('current_fitness' , '', $data); ?>
										</fieldset>
										<fieldset>
												<legend>What kind of experience do you have with similar activities or trips?</legend>
												<? $data = ['rows' => '10', 'cols' => '60']; ?>
												<?= form_textarea5('experience' , '', $data); ?>
										</fieldset>
										<fieldset>
												<li class = "new_line">
														<? $data = [ 'id' => 'is_fear_of_heights' , 'class' => 'wb']; ?>
														<?= form_checkbox('is_fear_of_heights' , $row->is_fear_of_heights, $row->is_fear_of_heights, $data) ?>
														<label  for="is_fear_of_heights" id="somelabel" class="<?= $row->is_fear_of_heights ? 'accepted' : '' ?>">Do you have a fear of heights or exposed places?</label>
												</li>
										</fieldset>
										<h4>Equipment</h4>
										<fieldset>
												<legend>Treks and Tracks provides equipment for you. In order to help your guide prepare, please mark equipment items that you wish to have provided for you.</legend>
												<li class = "new_line">
														<? $data = [ 'id' => 'have_backpack' , 'class' => 'wb']; ?>
														<?= form_checkbox('have_backpack' ,$row->have_backpack, $row->have_backpack, $data) ?>
														<label  for="have_backpack" id="somelabel" class="<?= $row->have_backpack ? 'accepted' : '' ?>">Bring a backpack? </label>
												</li>
												<li class = "new_line">
														<? $data = [ 'id' => 'have_tent' , 'class' => 'wb']; ?>
														<?= form_checkbox('have_tent' , $row->have_tent, $row->have_tent, $data) ?>
														<label  for="have_tent" id="somelabel" class="<?= $row->have_tent ? 'accepted' : '' ?>">Bring a tent? </label>
												</li>
												<li class = "new_line">
														<? $data = [ 'id' => 'have_sleeping_bag' , 'class' => 'wb']; ?>
														<?= form_checkbox('have_sleeping_bag' , $row->have_sleeping_bag, $row->have_sleeping_bag, $data) ?>
														<label  for="have_sleeping_bag" id="somelabel" class="<?= $row->have_sleeping_bag ? 'accepted' : '' ?>">Bring a sleeping bag </label>
												</li>
												<li class = "new_line">
														<? $data = [ 'id' => 'have_sleeping_pad' , 'class' => 'wb']; ?>
														<?= form_checkbox('have_sleeping_pad' , $row->have_sleeping_pad, $row->have_sleeping_pad, $data) ?>
														<label  for="have_sleeping_pad" id="somelabel" class="<?= $row->have_sleeping_pad ? 'accepted' : '' ?>">Bring a sleeping pad </label>
												</li>
										</fieldset>
										<h4>Dietary Preferences</h4>
										<fieldset>
												<legend>Do you have any dietary preferences or restrictions?</legend>
												<? $data = ['rows' => '10', 'cols' => '60']; ?>
												<?= form_textarea5('dietary_restrictions' , '', $data); ?>
										</fieldset>
										<fieldset>
												...
												<li class = "new_line">
														...
														<label  for="breakfast_coffee" id="somelabel" class="<?= $row->breakfast_coffee ? 'accepted' : '' ?>">Coffee </label>
												</li>
												<li class = "new_line">
														...
														<label  for="breakfast_black_tea" id="somelabel" class="<?= $row->breakfast_black_tea ? 'accepted' : '' ?>">Black Tea </label>
												</li>
												<li class = "new_line">
														...
														<label  for="breakfast_green_tea" id="somelabel" class="<?= $row->breakfast_green_tea ? 'accepted' : '' ?>">Green Tea </label>
												</li>
												<li class = "new_line">
														<? $data = [ 'id' => 'breakfast_herb_tea' , 'class' => 'wb']; ?>
														<?= form_checkbox('breakfast_herb_tea' , $row->breakfast_herb_tea, $row->breakfast_herb_tea, $data) ?>
														<label  for="breakfast_herb_tea" id="somelabel" class="<?= $row->breakfast_herb_tea ? 'accepted' : '' ?>">Herb Tea </label>
												</li>
												<li class = "new_line">
														...
														<label  for="breakfast_hot_chocolate" id="somelabel" class="<?= $row->breakfast_hot_chocolate ? 'accepted' : '' ?>">Hot Chocolate</label>
												</li>
												<li class = "new_line">
														<? $data = [ 'id' => 'breakfast_other' , 'class' => 'wb']; ?>
														<?= form_checkbox('breakfast_other' , $row->breakfast_other,  $row->breakfast_other, $data) ?>
														<label  for="breakfast_other" id="somelabel" class="<?= $row->breakfast_other ? 'accepted' : '' ?>">Other</label>
												</li>
												<li class = "new_line">
														<? $data = [ 'id' => 'breakfast_other_text' , 'class' => 'text']; ?>
														<label  for="breakfast_other_text" >Other Preference</label>
														<?= form_input('breakfast_other_text' , '' , $data) ?>
												</li>
										</fieldset>
								</div>
								...
								<div id= "right">
										...
										<fieldset>
												<li class = "new_line">
														...
														<label for= "is_asthma"  id="somelabel" class="<?= $row->is_asthma ? 'accepted' : '' ?>">Asthma/respiratory Illness </label>
												</li>
												<li class = "new_line">
														<? $data = [ 'id' => 'is_inhaler' , 'class' => 'wb']; ?>
														<?= form_checkbox('is_inhaler' , $row->is_inhaler, $row->is_inhaler, $data) ?>
														<label for= "is_inhaler" id="somelabel" class="<?= $row->is_inhaler ? 'accepted' : '' ?>">If yes, do you carry an inhaler?</label>
												</li>
												<li class = "new_line">
												...
												<li class = "new_line">
														...
														<label for="is_cardio_disease"  id="somelabel" class="<?= $row->is_cardio_disease ? 'accepted' : '' ?>">Cardiovascular disease </label>
												</li>
												<li class = "new_line">
														<? $data = [ 'id' => 'is_hypertension' , 'class' => 'wb']; ?>
														<?= form_checkbox('is_hypertension' , $row->is_hypertension , $row->is_hypertension, $data) ?>
														<label for="is_hypertension"  id="somelabel" class="<?= $row->is_hypertension ? 'accepted' : '' ?>">High blood pressure </label>
												</li>
												<li class = "new_line">
														...
														<label  for="is_knee_ankle_shoulder" id="somelabel" class="<?= $row->is_knee_ankle_shoulder ? 'accepted' : '' ?>">Joint (hip, knee, ankle, shoulder etc.) or back injuries (including sprains)</label>
												</li>
												<li class = "new_line">
														<? $data = [ 'id' => 'is_bleeding' , 'class' => 'wb']; ?>
														<?= form_checkbox('is_bleeding' , $row->is_bleeding, $row->is_bleeding, $data) ?>
														<label  for="is_bleeding" id="somelabel" class="<?= $row->is_bleeding ? 'accepted' : '' ?>">Bleeding or blood disorders </label>
												</li>
												<li class = "new_line">
														<? $data = [ 'id' => 'is_dizziness' , 'class' => 'wb']; ?>
														<?= form_checkbox('is_dizziness' , $row->is_dizziness, $row->is_dizziness, $data) ?>
														<label  for="is_dizziness" id="somelabel" class="<?= $row->is_dizziness ? 'accepted' : '' ?>">Dizziness or fainting episodes </label>
												</li>
												<li class = "new_line">
														...
														<label  for="is_see_medical_specialist" id="somelabel" class="<?= $row->is_see_medical_specialist ? 'accepted' : '' ?>">Do you see a medical/physical specialist of any kind</label>
												</li>
												<li>
														...
														<label  for="is_any_other_condition" id="somelabel" class="<?= $row->is_any_other_condition ? 'accepted' : '' ?>">Any other condition that would affect your performance or health</label>
												</li>
										</fieldset>
										<fieldset>
												<li>
														<h4>Please explain any yes responses in the space below – including approximate dates and current status.</h4>
														<? $data = ['rows' => '10', 'cols' => '60']; ?>
														<?= form_textarea5('response_explainations' , '', $data); ?>
												</li>
										</fieldset>
										<h3>Allergies</h3>
										...
										<fieldset>
												<li class = "new_line">
														...
														<label  for="is_allergic_medications"  id="somelabel" class="<?= $row->is_allergic_medications ? 'accepted' : '' ?>">Medications </label>
												</li>
												<li class = "new_line">
														...
														<label  for="is_allergic_insect_stings"  id="somelabel" class="<?= $row->is_allergic_insect_stings ? 'accepted' : '' ?>">Insect stings (If yes, we strongly recommend that you carry medication.) </label>
												</li>
												<li class = "new_line">
														<? $data = [ 'id' => 'is_allergic_food' , 'class' => 'wb']; ?>
														<?= form_checkbox('is_allergic_food' , $row->is_allergic_food, $row->is_allergic_food, $data) ?>
														<label  for="is_allergic_food"  id="somelabel" class="<?= $row->is_allergic_food ? 'accepted' : '' ?>">Food allergies</label>
												</li>
												<li class = "new_line">
														<? $data = [ 'id' => 'is_allergic_other' , 'class' => 'wb']; ?>
														<?= form_checkbox('is_allergic_other' , $row->is_allergic_other, $row->is_allergic_other, $data) ?>
														<label  for="is_allergic_other"  id="somelabel" class="<?= $row->is_allergic_other ? 'accepted' : '' ?>">Other </label>
												</li>
										</fieldset>
										<fieldset>
												<li class = "new_line">
														...
														<h4>
														Please explain any yes responses in the space below – including description of allergic response.
														<h4>
														<? $data = ['rows' => '10', 'cols' => '60']; ?>
														<?= form_textarea5('allergy_explainations' , '', $data); ?>
												</li>
										</fieldset>
										<h3>Medications</h3>
										<fieldset>
												<li class = "new_line">
														...
														<label  for="is_medications" id="somelabel" class="<?= $row->is_medications ? 'accepted' : '' ?>">Are you currently taking any medications? </label>
												</li>
										</fieldset>
										<fieldset>
												<li>
														<h4>If yes, please list medication, dosage, and condition for which you are taking the medication</h4>
														<? $data = ['rows' => '10', 'cols' => '60']; ?>
														<?= form_textarea5('medication_explainations' , '', $data); ?>
												</li>
										</fieldset>
										<fieldset>
												<li class = "new_line">
														...
														<label  for="is_pregnant" id="somelabel" class="<?= $row->is_pregnant ? 'accepted' : '' ?>">Are you pregnant? </label>
												</li>
												<li class = "new_line">
														<? $data = [ 'id' => 'is_questionaire_checked' , 'class' => 'wb']; ?>
														<?= form_checkbox('is_questionaire_checked' , "Yes", TRUE, $data) ?>
														<label  for="is_questionaire_checked" id="somelabel" >I checked this questionaire! </label>
												</li>
										</fieldset>
						</ul>
