...
<? foreach ($events as $event) : ?>
	...
	<? endif ?>
								...
								<div id="content-box2"> <?= date('g:i',strtotime($event['event_time'])) . ' - '; ?> <?= date('g:i',strtotime($event['event_time'])+$event['duration']*3600); ?> </div>
...
<? foreach ($events as $event) : ?>
					...
					<div style=" padding: 0.4em; padding-left: 1.5em;  padding-right: 1.5em; display: none; " id="do_book<?= $j ?>" title="Number of Students and Promo Code">
...
<fieldset>	<div>						
								...
								<input type="hidden" name="event_date" id="event_date<?= $j ?>" value="<?= $event['event_date']; ?>" />
								<input type="hidden" name="event_id" id="event_id<?= $j ?>" value="<?= $event['event_event_id']; ?>" />
...
<fieldset>						
			<div>					
								...
								<input type="text" class="text" onMouseOut="xajax_verify_promo_code()" size="10" id="promo_code<?= $j ?>"  name="promo_code" value="">
			</div>					
</fieldset>	
			<div>	
								<input type="submit"  id="update<?= $j ?>"  name="update<?= $j ?>" value="Continue" class="submit" />
			</div>
					</form>
					</p>
...
<div class="FBG">
		<div class="FBG_resize">
				...
				<div class="blok">
						<h2>Image Gallery</h2>
						<img src="<?= base_url() ?>images/greeny/banner_1.gif" alt="img" width="68" height="68" /><img src="<?= base_url() ?>images/greeny/banner_2.jpg" alt="img" width="68" height="68" /><img src="<?= base_url() ?>images/greeny/banner_3.jpg" alt="img" width="68" height="68" /><img src="<?= base_url() ?>images/greeny/banner_4.jpg" alt="img" width="68" height="68" /><img src="<?= base_url() ?>images/greeny/banner_5.jpg" alt="img" width="68" height="68" /><img src="<?= base_url() ?>images/greeny/banner_6.jpg" alt="img" width="68" height="68" />
						<div class="clr"></div>
						<h2>Lorem ipsum </h2>
