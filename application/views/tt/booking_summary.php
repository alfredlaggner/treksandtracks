<style>
#booking_data h4 { font: normal 16px Arial, Helvetica, sans-serif; color:#464646; padding:5px; margin:0 0 0px 40px; }
#booking_data h3 { font: normal 20px Arial, Helvetica, sans-serif; color:#464646; padding:2px; margin:0 0 0 20px; }
#booking_data h2 { font: normal 28px Arial, Helvetica, sans-serif; color:#464646; padding:5px; margin:0 0 10px 0; }
#booking_data h2 { border-bottom-color:#000000; border-bottom-style:dotted; border-bottom-width:thin; }
#booking_data #total { border-top-color:#000000; border-top-style:dotted; border-top-width: thin; }
#booking_data h2 span { color:#9eaf06; }
#booking_data .bleft p { color:#4b4b4b; font: normal 14px Arial, Helvetica, sans-serif; padding:5px 0; margin:0 0 0 40px; line-height:1.8em; }
#booking_data a { color:#9eaf06; text-decoration:none; font: bold 12px Arial, Helvetica, sans-serif; }
#booking_data ul { list-style: disc; /*width:130px; */ float:left; padding:0; margin:10px 5px; }
#booking_data li { padding:2px 1px; margin:0; }
#booking_data li a { color:#9eaf06; font: normal 12px Arial, Helvetica, sans-serif; text-decoration: underline; }
#booking_data li a:hover { color:#4b4b4b; text-decoration:none; }
#booking_data .blok { width:30%; float:left; padding:15px 11px; margin:0; }
#booking_data .title { float:left; width:100%; margin:0; padding:20px 0 0 0; }
#booking_data .bleft { float:left; width:60%; margin:0; padding:0 0 0px 0; }
#booking_data .bright { float:right; width:40%; margin:0; padding:0 0 0px 0; }
#booking_data h3 span { font-size:9px; font-weight:normal }
</style>
</head><body>
		...
		$total_price += $sub_price;
		 ?>
								...
								<div class="bleft">
										...
										<h3><?= $row->name; ?></h3>
										<h4> On <b><?= date('F jS  Y ',strtotime($row->date)); ?></b> from <b><?= date('g:i a',strtotime($row->time)); ?> </b> to <b><?= date('g:i a',strtotime($row->time)+$row->duration * 3600); ?></b></h4>
								</div>
								<div class="title">
										<h2></h2>
								</div>
