...
$db['hosted']['dbprefix'] = '';
$db['hosted']['pconnect'] = TRUE;
$db['hosted']['db_debug'] = TRUE;
$db['hosted']['cache_on'] = FALSE;
$db['hosted']['cachedir'] = '';
$db['hosted']['char_set'] = 'utf8';
$db['hosted']['dbcollat'] = 'utf8_general_ci';
$db['hosted']['swap_pre'] = '';
...
$db['sunnydays']['password'] = 'laggner';
$db['sunnydays']['database'] = 'treksandtracks_tretra7';
$db['sunnydays']['dbdriver'] = 'mysqli';
$db['sunnydays']['dbprefix'] = '';
$db['sunnydays']['pconnect'] = FALSE;
$db['sunnydays']['db_debug'] = TRUE;
$db['sunnydays']['cache_on'] = FALSE;
$db['sunnydays']['cachedir'] = 'cache';
$db['sunnydays']['char_set'] = 'utf8';
$db['sunnydays']['dbcollat'] = 'utf8_general_ci';
$db['sunnydays']['swap_pre'] = '';
$db['sunnydays']['autoinit'] = TRUE;
