...
<meta Name="Keywords" Content="climbing classes, rock climbing, horsepacking trips, adventure travel, back country skiing" />
<? else :?>
...
-->
    ...
    <![endif]-->
    <script type="text/javascript" src="<?= base_url() . JS_DIR ?>jquery.1.7.min.js"></script>
	<script type="text/javascript" src="<?= base_url() . JS_DIR ?>jquery.columnizer.min.js" charset="utf-8"></script>    
    <script type="text/javascript" src="<?= base_url() . JS_DIR ?>jquery.isotope.min.js"></script>
    <script type="text/javascript" src="<?= base_url() . JS_DIR ?>app.js"></script>
    <script type="text/javascript" src="<?= base_url() . JS_DIR ?>chosen.jquery.min.js"></script>
    <script type="text/javascript" src="<?= base_url() . JS_DIR ?>jquery.plugins.js"></script>
    <script type="text/javascript" src="<?= base_url() . JS_DIR ?>akaishi.js"></script>
<!--    <script type="text/javascript" src="<?= base_url() . JS_DIR ?>scrollpane/jquery.jscrollpane.js"></script>
    <script type="text/javascript" src="<?= base_url() . JS_DIR ?>scrollpane/jquery.mousewheel.js"></script>
    <script type="text/javascript" src="<?= base_url() . JS_DIR ?>scrollpane/mwheelIntent.js"></script>
-->	
...
<script type="text/javascript" src="<?= base_url() . JS_DIR ?>shadowbox.js"></script>
...
-->	
    ...
    <link rel="stylesheet" type="text/css" href="<?= base_url() . CSS_DIR ?>squaregrid.css" media="all" />
    <link rel="stylesheet" type="text/css" href="<?= base_url() . CSS_DIR ?>chosen.css" media="all" />
    <link rel="stylesheet" type="text/css" href="<?= base_url() . CSS_DIR ?>layout.css" media="all" />
    <link rel="stylesheet" type="text/css" href="<?= base_url() . CSS_DIR ?>shadowbox.css" media="all" />
    <link rel="stylesheet" type="text/css" href="<?= base_url() . CSS_DIR ?>jquery.jscrollpane.css" media="all" />
...
--> <script defer='defer' id='cjax_lib' type='text/javascript' src='../../application/views/tt2/blocks/cjax/core/js/cjax-5.0-Stable.min.js'></script>  
