				...
				<table id="sort-table">
					...
					<tbody>
						...
						<tr>
							...
							<a class="btn_no_text btn ui-state-default ui-corner-all tooltip " title="View History" href="<?php echo site_url().'customer_contact/customer_contact_overview/' ?><?php echo $row->customer_id; ?>"> <span class="ui-icon ui-icon-mail-closed"></span> </a> 
<? if ($event_id) : ?>							
							<a class="btn_no_text btn ui-state-default ui-corner-all tooltip confirmClick " title="Delete customer" href="<?php echo site_url().'customer_contact/delete/' ?><?php echo $row->customer_id;  ?>/<?php echo $event_id;  ?>/<?php echo $location_id;  ?>" > <span class="ui-icon ui-icon-trash"></span> </a> 
<? endif ?>							
